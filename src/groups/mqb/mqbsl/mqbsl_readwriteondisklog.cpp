...
int ReadWriteOnDiskLog::flush(BSLA_MAYBE_UNUSED Offset offset)
{
...
int ReadWriteOnDiskLog::alias(BSLA_MAYBE_UNUSED void** entry,
...
int ReadWriteOnDiskLog::alias(BSLA_MAYBE_UNUSED bdlbb::Blob* entry,
                              BSLA_MAYBE_UNUSED int          length,
                              BSLA_MAYBE_UNUSED Offset       offset) const
{
    BSLS_ASSERT_OPT(false && "Aliasing is not supported for"
