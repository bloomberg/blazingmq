...
const char StatPluginConfig::DEFAULT_INITIALIZER_MODE[] = "pull";

const char StatPluginConfig::DEFAULT_INITIALIZER_HOST[] = "localhost";

const int StatPluginConfig::DEFAULT_INITIALIZER_PORT = 8080;
