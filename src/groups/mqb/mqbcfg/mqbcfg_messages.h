...
class TcpInterfaceListener {
    ...
    // on.  tls..................: Use TLS on this interface.
...
class TlsConfig {
  ...
  public:
    ...
    TlsConfig(const TlsConfig& original,
              bslma::Allocator *basicAllocator = 0);
...
inline
unsigned int& ElectorConfig::quorum()
{
    return d_quorum;
}
...
inline
unsigned int ElectorConfig::quorum() const
{
    return d_quorum;
}
...
// PRIVATE ACCESSORS
template <typename t_HASH_ALGORITHM>
void TcpInterfaceListener::hashAppendImpl(t_HASH_ALGORITHM& hashAlgorithm) const
{
    using bslh::hashAppend;
...
inline
bool TcpInterfaceListener::tls() const
{
    return d_tls;
}
...
int TlsConfig::manipulateAttributes(t_MANIPULATOR& manipulator)
{
    ...
    ret = manipulator(&d_certificateAuthority, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_CERTIFICATE_AUTHORITY]);
    if (ret) {
        return ret;
    }

    ret = manipulator(&d_certificate, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_CERTIFICATE]);
    if (ret) {
        return ret;
    }
    ...
    ret = manipulator(&d_versions, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_VERSIONS]);
    if (ret) {
        return ret;
    }
...
int TlsConfig::manipulateAttribute(t_MANIPULATOR& manipulator, int id)
{
    ...
    switch (id) {
      case ATTRIBUTE_ID_CERTIFICATE_AUTHORITY: {
        return manipulator(&d_certificateAuthority, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_CERTIFICATE_AUTHORITY]);
      }
      case ATTRIBUTE_ID_CERTIFICATE: {
        return manipulator(&d_certificate, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_CERTIFICATE]);
      }
      case ATTRIBUTE_ID_KEY: {
        return manipulator(&d_key, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_KEY]);
      }
      case ATTRIBUTE_ID_VERSIONS: {
        return manipulator(&d_versions, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_VERSIONS]);
      }
      default:
        return NOT_FOUND;
    }
...
template <typename t_MANIPULATOR>
int TlsConfig::manipulateAttribute(
        t_MANIPULATOR& manipulator,
        const char    *name,
        int            nameLength)
{
...
inline
bsl::string& TlsConfig::certificateAuthority()
{
    return d_certificateAuthority;
}

inline
bsl::string& TlsConfig::certificate()
{
    return d_certificate;
}

inline
bsl::string& TlsConfig::key()
{
    return d_key;
}

inline
bsl::string& TlsConfig::versions()
{
    return d_versions;
}
...
int TlsConfig::accessAttributes(t_ACCESSOR& accessor) const
{
    ...
    ret = accessor(d_certificateAuthority, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_CERTIFICATE_AUTHORITY]);
    if (ret) {
        return ret;
    }

    ret = accessor(d_certificate, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_CERTIFICATE]);
    if (ret) {
        return ret;
    }
...
int TlsConfig::accessAttribute(t_ACCESSOR& accessor, int id) const
{
    ...
    switch (id) {
      case ATTRIBUTE_ID_CERTIFICATE_AUTHORITY: {
        return accessor(d_certificateAuthority, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_CERTIFICATE_AUTHORITY]);
      }
      case ATTRIBUTE_ID_CERTIFICATE: {
        return accessor(d_certificate, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_CERTIFICATE]);
      }
      case ATTRIBUTE_ID_KEY: {
        return accessor(d_key, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_KEY]);
      }
      case ATTRIBUTE_ID_VERSIONS: {
        return accessor(d_versions, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_VERSIONS]);
      }
      default:
        return NOT_FOUND;
    }
...
inline
const bsl::string& TlsConfig::certificateAuthority() const
{
    return d_certificateAuthority;
}

inline
const bsl::string& TlsConfig::certificate() const
{
    return d_certificate;
}

inline
const bsl::string& TlsConfig::key() const
{
    return d_key;
}

inline
const bsl::string& TlsConfig::versions() const
{
    return d_versions;
}
...
int AppConfig::manipulateAttributes(t_MANIPULATOR& manipulator)
{
    ...
    ret = manipulator(&d_tlsConfig, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_TLS_CONFIG]);
    if (ret) {
        return ret;
    }
...
int AppConfig::manipulateAttribute(t_MANIPULATOR& manipulator, int id)
{
    ...
    switch (id) {
      ...
      case ATTRIBUTE_ID_TLS_CONFIG: {
        return manipulator(&d_tlsConfig, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_TLS_CONFIG]);
      }
      default:
        return NOT_FOUND;
    }
...
inline
bdlb::NullableValue<TlsConfig>& AppConfig::tlsConfig()
{
    return d_tlsConfig;
}
...
int AppConfig::accessAttributes(t_ACCESSOR& accessor) const
{
    ...
    ret = accessor(d_tlsConfig, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_TLS_CONFIG]);
    if (ret) {
        return ret;
    }
...
int AppConfig::accessAttribute(t_ACCESSOR& accessor, int id) const
{
    ...
    switch (id) {
      ...
      case ATTRIBUTE_ID_TLS_CONFIG: {
        return accessor(d_tlsConfig, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_TLS_CONFIG]);
      }
      default:
        return NOT_FOUND;
    }
...
inline
const bdlb::NullableValue<TlsConfig>& AppConfig::tlsConfig() const
{
    return d_tlsConfig;
}
