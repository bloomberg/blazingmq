...
class DispatcherProcessorParameters {
  ...
  public:
    ...
    DispatcherProcessorParameters(const DispatcherProcessorParameters& original);
        // Create an object of type 'DispatcherProcessorParameters' having the
        // value of the specified 'original' object.

#if defined(BSLS_COMPILERFEATURES_SUPPORT_RVALUE_REFERENCES) \
 && defined(BSLS_COMPILERFEATURES_SUPPORT_NOEXCEPT)
    DispatcherProcessorParameters(DispatcherProcessorParameters&& original) = default;
        // Create an object of type 'DispatcherProcessorParameters' having the
    ...
    // MANIPULATORS
    DispatcherProcessorParameters& operator=(const DispatcherProcessorParameters& rhs);
        // Assign to this object the value of the specified 'rhs' object.
...
inline
bsl::string& StatPluginConfig::mode()
{
    return d_mode;
}

inline
bsl::string& StatPluginConfig::host()
{
    return d_host;
}

inline
int& StatPluginConfig::port()
{
    return d_port;
}
...
inline
const bsl::string& StatPluginConfig::mode() const
{
    return d_mode;
}

inline
const bsl::string& StatPluginConfig::host() const
{
    return d_host;
}

inline
int StatPluginConfig::port() const
{
    return d_port;
}
