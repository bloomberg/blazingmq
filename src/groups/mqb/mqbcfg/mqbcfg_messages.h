...
class AppConfig {
    ...
    // wait for a routed command's response tlsConfig............: optional
...
inline
bool ClustersDefinition::isEqualTo(const ClustersDefinition& rhs) const
{
    return this->myClusters() == rhs.myClusters() &&
           ...
           this->reversedClusterConnections() == rhs.reversedClusterConnections();
}
...
// GENERATED BY BLP_BAS_CODEGEN_2025.05.08
