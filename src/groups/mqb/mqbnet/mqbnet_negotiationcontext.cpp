...
, d_maxMissedHeartbeat(maxMissedHeartbeat)
...
NegotiationContext& NegotiationContext::setMaxMissedHeartbeat(int value)
{
...
int NegotiationContext::maxMissedHeartbeat() const
{
