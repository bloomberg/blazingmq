...
//@PURPOSE: Provide a DispatcherEvent interface view for 'e_CALLBACK' events.
//
//@CLASSES:
//  mqbevt::CallbackEvent: Interface view for 'e_CALLBACK' events
//
//@DESCRIPTION: 'mqbevt::CallbackEvent' provides a DispatcherEvent interface
// view of an event of type 'e_CALLBACK'.
