...
//@PURPOSE: Provide a DispatcherEvent interface view for 'e_RECOVERY' events.
//
//@CLASSES:
//  mqbevt::RecoveryEvent: Interface view for 'e_RECOVERY' events
//
//@DESCRIPTION: 'mqbevt::RecoveryEvent' provides a DispatcherEvent interface
// view of an event of type 'e_RECOVERY'.
