...
//'e_CLUSTER_STATE' events.
//
//@CLASSES:
//  mqbevt::ClusterStateEvent: Implementation for 'e_CLUSTER_STATE' events
//
...
class ClusterStateEvent : public mqbi::DispatcherEvent {
  ...
  public:
    ...
    ClusterStateEvent& setSource(mqbi::DispatcherClient* value);
...
inline mqbi::DispatcherClient* ClusterStateEvent::source() const
{
    return d_source_p;
}
