...
{
    // Dispatcher events are always used with shared object pools.  The
    // finalize callback is invoked here, when all references to the shared
    // pointer are gone and the event is being returned to its pool.
