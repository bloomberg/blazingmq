...
//@PURPOSE: Provide a DispatcherEvent interface view for 'e_STORAGE' events.
//
//@CLASSES:
//  mqbevt::StorageEvent: Interface view for 'e_STORAGE' events
//
//@DESCRIPTION: 'mqbevt::StorageEvent' provides a DispatcherEvent interface
// view of an event of type 'e_STORAGE'.
...
/// DispatcherEvent interface view of an event of type `e_STORAGE`.
class StorageEvent {
  public:
    // CREATORS
