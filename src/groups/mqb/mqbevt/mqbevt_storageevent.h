...
// mqbevt_storageevent.h                                              -*-C++-*-
#ifndef INCLUDED_MQBEVT_STORAGEEVENT
#define INCLUDED_MQBEVT_STORAGEEVENT

//@PURPOSE: Provide a mqbi::DispatcherEvent implementation for 'e_STORAGE'
// events.
//
//@CLASSES:
//  mqbevt::StorageEvent: Implementation for 'e_STORAGE' events
//
//@DESCRIPTION: 'mqbevt::StorageEvent' provides a concrete implementation
// of a dispatcher event of type 'e_STORAGE'.
...
class StorageEvent : public mqbi::DispatcherEvent {
  public:
    ...
    static const mqbi::DispatcherEventType::Enum k_TYPE =
        mqbi::DispatcherEventType::e_STORAGE;
  ...
  public:
    ...
    explicit StorageEvent(bslma::Allocator* allocator);

    /// Destructor.
    ~StorageEvent() BSLS_KEYWORD_OVERRIDE;

    // MANIPULATORS

    /// Set the blob to the specified `value` and return a reference
    /// offering modifiable access to this object.
    StorageEvent& setBlob(const bsl::shared_ptr<bdlbb::Blob>& value);
...
inline mqbnet::ClusterNode* StorageEvent::clusterNode() const
{
