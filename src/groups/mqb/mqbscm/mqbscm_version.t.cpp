...
int main(int argc, char** argv)
{
    ...
    case 1: {
        ...
        bsl::string version(mqbscm::Version::version());
        BSLIM_TESTUTIL_ASSERT(version == "BLP_LIB_MQB_99.99.99");

        if (verbose)
            cout << "Checking version int" << endl;
        BSLIM_TESTUTIL_ASSERT(mqbscm::Version::versionAsInt() == 999999);
    } break;
