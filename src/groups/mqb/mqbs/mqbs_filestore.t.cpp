...
static void test9_proposalReuse()
// ------------------------------------------------------------------------
// PROPOSAL REUSE
//
// Concerns:
//   Every 'init*' leaves the fields of the record types it is not for at
//   their defaults, so a pooled 'Proposal' carries nothing over from
//   its previous use.
//
// Testing:
//   Proposal::initMessage
//   Proposal::initConfirm
//   Proposal::initQueueCreation
//   Proposal::reset
// ------------------------------------------------------------------------
{
    bmqtst::TestHelper::printTestName("PROPOSAL REUSE");
    ...
    // not survive into the next use: 'onRecordCommittedPrimary' branches on
...
int main(int argc, char* argv[])
{
    ...
    switch (_testCase) {
    case 0:
    case 9: test9_proposalReuse(); break;
