...
class PartitionStateTableActions {
  ...
  public:
    ...
    void
    do_startWatchDog_openRecoveryFileSet_storeSelfMaxFileSizes_storeSelfSeq_replicaStateRequest_checkQuorumMaxFileSizesAndSeq(
        const ARGS& args);

    void
    do_startWatchDog_openRecoveryFileSet_storeSelfMaxFileSizes_storeSelfSeq_primaryStateRequest(
        const ARGS& args);
...
#define PST_CFG(s, e, a, n)                                                   \
    Table::configure(State::e_##s,                                            \
        ...
        PST_CFG(
            UNKNOWN,
            DETECT_SELF_PRIMARY,
            startWatchDog_openRecoveryFileSet_storeSelfMaxFileSizes_storeSelfSeq_replicaStateRequest_checkQuorumMaxFileSizesAndSeq,
            PRIMARY_HEALING_STG1);
        PST_CFG(
            UNKNOWN,
            DETECT_SELF_REPLICA,
            startWatchDog_openRecoveryFileSet_storeSelfMaxFileSizes_storeSelfSeq_primaryStateRequest,
            REPLICA_HEALING);
