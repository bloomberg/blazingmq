...
struct PartitionStateTableEvent {
    ...
    enum Enum {
        /// Can *only* be generated by the Cluster FSM, currently This event
        /// conly possible via `mqbc::ClusterStateManager::markOrphan`.
        e_RST_UNKNOWN = 0,

        /// Can *only* be generated by the Cluster FSM as part of CSL commit.
        e_DETECT_SELF_PRIMARY = 1,
        e_DETECT_SELF_REPLICA = 2,

        /// Generated by the reapply mechanism (watchdog timeout, error
        /// recovery) to retry role detection.
