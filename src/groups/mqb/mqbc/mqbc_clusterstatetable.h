...
struct ClusterStateTableEvent {
    ...
    enum Enum {
        ...
        /// Self is transitioned as follower by the Elector.
        e_SLCT_FOL = 1,

        /// Generated by the reapply mechanism (watchdog timeout) to retry
        /// leader healing.
        e_REAPPLY_LDR = 2,
