...
#define MQBA_ASSERT_POOL_FREE(pool)                                           \
    ...
    MQBA_ASSERT_POOL_FREE(d_clusterStateEventPool);
    MQBA_ASSERT_POOL_FREE(d_confirmEventPool);
    MQBA_ASSERT_POOL_FREE(d_controlMessageEventPool);
    MQBA_ASSERT_POOL_FREE(d_dispatcherEventPool);
    MQBA_ASSERT_POOL_FREE(d_pushEventPool);
    MQBA_ASSERT_POOL_FREE(d_putEventPool);
    MQBA_ASSERT_POOL_FREE(d_receiptEventPool);
    MQBA_ASSERT_POOL_FREE(d_recoveryEventPool);
    MQBA_ASSERT_POOL_FREE(d_rejectEventPool);
    MQBA_ASSERT_POOL_FREE(d_storageEventPool);

#undef MQBA_ASSERT_POOL_FREE
}
