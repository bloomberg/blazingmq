...
const Test k_TESTS[] = {
    ...
    {__LINE__,
     ...
     0},
    {__LINE__,
     "DOMAINS DOMAIN rejects traversal",
     "DOMAINS DOMAIN ../../secret INFOS",
     0},
    {__LINE__,
     "DOMAINS RECONFIGURE rejects traversal",
     "DOMAINS RECONFIGURE ../../secret",
     0},
    {__LINE__,
     "DOMAINS REMOVE rejects path separators",
     "DOMAINS REMOVE nested/secret",
     0},
    {__LINE__,
    ...
    {__LINE__,
     "domain resolver cache clear rejects traversal",
     "DOMAINS RESOLVER CACHE_CLEAR ../../secret",
     0},
    {__LINE__,
    ...
    {__LINE__,
     "configuration provider cache clear rejects traversal",
     "CONFIGPROVIDER CACHE_CLEAR ../../secret",
     0},
    {__LINE__,
