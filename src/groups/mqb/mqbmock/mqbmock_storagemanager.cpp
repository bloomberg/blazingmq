...
StorageManager::partition(BSLA_MAYBE_UNUSED int partitionId)
{
    return 0;
}

mqbs::RecordStore*
StorageManager::recordStore(BSLA_MAYBE_UNUSED int partitionId)
{
    return 0;
}
...
bool StorageManager::loadAppIds(
    BSLA_MAYBE_UNUSED bsl::unordered_set<bsl::string>* out,
    BSLA_MAYBE_UNUSED const bmqt::Uri& uri,
    BSLA_MAYBE_UNUSED int              partitionId) const
{
    return false;
