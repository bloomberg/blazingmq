...
//       used here
, d_config_sp(bsl::allocate_shared<mqbconfm::Domain>(allocator))
...
{
    d_config_sp = bsl::allocate_shared<mqbconfm::Domain>(d_allocator_p,
                                                         config);
    return 0;
}
...
const bsl::shared_ptr<mqbconfm::Domain>& Domain::config() const
{
    return d_config_sp;
}
