 ...
 * 
 * @param event_obj A pointer to a pointer to the z_bmqa_MessageEvent object to be deleted.
 * 
 ...
 * 
 * @param event_obj A pointer to a pointer to the z_bmqa_MessageEvent object to be created.
 * 
 ...
 * 
 * @param event_obj    A pointer to a const z_bmqa_MessageEvent object.
 ...
 * 
 * This function converts the z_bmqa_MessageEvent object 'event_obj' to a string
