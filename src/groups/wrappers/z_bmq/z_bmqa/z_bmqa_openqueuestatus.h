 ...
 * 
 * @param status_obj A pointer to a pointer to the z_bmqa_OpenQueueStatus object to be deleted.
 * 
 ...
 * 
 * @param status_obj A pointer to a pointer to the z_bmqa_OpenQueueStatus object to be created.
 * 
 ...
 * 
 * @param status_obj A pointer to a pointer to the z_bmqa_OpenQueueStatus object where the copy will be stored.
 ...
 * 
 * @param status_obj A pointer to the const z_bmqa_OpenQueueStatus object.
 * 
 ...
 * 
 * @param status_obj   A pointer to the const z_bmqa_OpenQueueStatus object.
 * @param queueId_obj  A pointer to a pointer to the const z_bmqa_QueueId object to store the queue ID.
 * 
