 ...
 * 
 * @param queueId_obj A pointer to a pointer to the z_bmqa_QueueId object to be deleted.
 * 
 ...
 * 
 * @param queueId_obj A pointer to a pointer to the z_bmqa_QueueId object to be created.
 * 
 ...
 * 
 * @param queueId_obj A pointer to a pointer to the z_bmqa_QueueId object where the copy will be stored.
 ...
 */
int z_bmqa_QueueId__createCopy(z_bmqa_QueueId**      queueId_obj,
 ...
 * @return Returns 0 upon successful creation of the object.
 */
int z_bmqa_QueueId__createFromNumeric(z_bmqa_QueueId** queueId_obj,
                                      int64_t          numeric);
 ...
 * @return Returns 0 upon successful creation of the object.
 */
int z_bmqa_QueueId__createFromPointer(z_bmqa_QueueId** queueId_obj,
                                      void*            pointer);
 ...
 * 
 * @param queueId_obj   A pointer to the const z_bmqa_QueueId object.
 * @param queueId_obj   A pointer to a pointer to the const z_bmqt_CorrelationId object to store the correlation ID.
 * 
 * @return Returns 0 upon successful retrieval.
 */
const z_bmqt_CorrelationId*
z_bmqa_QueueId__correlationId(const z_bmqa_QueueId* queueId_obj);
