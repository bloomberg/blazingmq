 ...
 * 
 * @param sessionEvent A pointer to a pointer to the session event object to be deleted.
 * 
 ...
 * 
 * @param sessionEvent A pointer to a pointer to store the created session event object.
 * 
 ...
 * 
 * @param sessionEvent A pointer to a pointer to store the copied session event object.
 ...
 * 
 * @param sessionEvent A pointer to the session event object.
 * 
