 ...
 * 
 * This function deletes the z_bmqa_ConfirmEventBuilder object pointed to by 'builder_obj'.
 * Upon successful completion, the memory pointed to by 'builder_obj' will be deallocated,
 * and 'builder_obj' will be set to NULL.
 * 
 * @param builder_obj A pointer to a pointer to a z_bmqa_ConfirmEventBuilder object to be deleted.
 * 
 ...
 * a pointer to it in the memory pointed to by 'builder_obj'.
 * 
 * @param builder_obj A pointer to a pointer to a z_bmqa_ConfirmEventBuilder object where
 ...
 * to the z_bmqa_ConfirmEventBuilder object 'builder_obj'.
 * 
 * @param builder_obj A pointer to a z_bmqa_ConfirmEventBuilder object to which the message
 ...
 * object 'cookie' to the z_bmqa_ConfirmEventBuilder object 'builder_obj'.
 * 
 * @param builder_obj A pointer to a z_bmqa_ConfirmEventBuilder object to which the message
 *                    confirmation will be added.
 ...
 * 
 * This function resets the z_bmqa_ConfirmEventBuilder object 'builder_obj' to its initial state.
 * 
 * @param builder_obj A pointer to a z_bmqa_ConfirmEventBuilder object to be reset.
 * 
 ...
 * z_bmqa_ConfirmEventBuilder object 'builder_obj'.
 * 
 * @param builder_obj A pointer to a z_bmqa_ConfirmEventBuilder object from which the message count
 *                    will be retrieved.
 * 
 ...
 * 
 * This function retrieves the blob from the z_bmqa_ConfirmEventBuilder object 'builder_obj'.
 * 
 * @param builder_obj A pointer to a z_bmqa_ConfirmEventBuilder object from which the blob
 *                    will be retrieved.
