 ...
 * 
 * @param messageIterator A pointer to a pointer to the z_bmqa_MessageIterator object to be created.
 * 
 ...
 * 
 * @param messageIterator A pointer to a pointer to the z_bmqa_MessageIterator object to be deleted.
 * 
 ...
 * 
 * @param messageIterator A pointer to the z_bmqa_MessageIterator object.
 * 
 ...
 * 
 * @param messageIterator A pointer to the const z_bmqa_MessageIterator object.
 * @param messageOut         A pointer to a pointer to a const z_bmqa_Message object where the retrieved
