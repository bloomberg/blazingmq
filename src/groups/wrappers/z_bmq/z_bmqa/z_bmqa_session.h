 ...
 * 
 * @param session Pointer to the Session object to be deleted.
 * 
 ...
 * 
 * @param session Pointer to store the created Session object.
 ...
 * 
 * @param session Pointer to the Session object to start.
 ...
 * 
 * @param session Pointer to the Session object to stop.
 * 
