 ...
 *
 * @param messageProperties A pointer to a z_bmqa_MessageProperties object to be cleared.
 */
 ...
 *
 * @param messageProperties A pointer to a z_bmqa_MessageProperties object.
 ...
 *
 * @param messageProperties A pointer to a pointer to a z_bmqa_MessageProperties object.
 ...
 *
 * @param messageProperties A pointer to a pointer to a z_bmqa_MessageProperties object where the new object will be stored.
 ...
 *
 * @param messageProperties A pointer to a pointer to a z_bmqa_MessageProperties object where the copy will be stored.
...
int z_bmqa_MessageProperties__numProperties(
    const z_bmqa_MessageProperties* messageProperties); 
