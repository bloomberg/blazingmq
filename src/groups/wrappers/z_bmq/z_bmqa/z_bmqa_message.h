 ...
 * 
 * This function deletes the z_bmqa_Message object pointed to by 'message'.
 * Upon successful completion, the memory pointed to by 'message' will be deallocated,
 * and 'message' will be set to NULL.
 * 
 * @param message A pointer to a pointer to a z_bmqa_Message object to be deleted.
 * 
 * @return Returns 0 upon successful deletion.
 */
int z_bmqa_Message__delete(z_bmqa_Message** message);

/**
 * @brief Creates a new z_bmqa_Message object.
 * 
 * This function creates a new z_bmqa_Message object and stores
 * a pointer to it in the memory pointed to by 'message'.
 * 
 * @param message A pointer to a pointer to a z_bmqa_Message object where
 *                   the newly created object will be stored.
 * 
 * @return Returns 0 upon successful creation.
 */
int z_bmqa_Message__create(z_bmqa_Message** message);

/**
 * @brief Sets the data of a z_bmqa_Message object.
 * 
 * This function sets the data of the z_bmqa_Message object 'message' to the
 * provided 'data' with the given 'length'.
 * 
 * @param message A pointer to a z_bmqa_Message object.
 * @param data        A pointer to the data.
 * @param length      The length of the data.
 * 
 * @return Returns 0 upon successful operation.
 */
int z_bmqa_Message__setDataRef(z_bmqa_Message* message,
                               const char*     data,
                               int             length);
 ...
 * 
 * This function sets the properties of the z_bmqa_Message object 'message' to
 ...
 * 
 * This function clears the properties of the z_bmqa_Message object 'message'.
 * 
 * @param message A pointer to a z_bmqa_Message object.
 * 
 * @return Returns 0 upon successful operation.
 */
int z_bmqa_Message__clearPropertiesRef(z_bmqa_Message* message);

/**
 * @brief Sets the correlation ID of a z_bmqa_Message object.
 * 
 * This function sets the correlation ID of the z_bmqa_Message object 'message'
 ...
 * 'message' to the provided value 'value'.
 * 
 * @param message A pointer to a z_bmqa_Message object.
 ...
 * 
 * This function sets the group ID of the z_bmqa_Message object 'message' to
 ...
 * @return Returns 0 upon successful operation.
 */
int z_bmqa_Message__setGroupId(z_bmqa_Message* message,
                               const char*     groupId);

/**
 * @brief Clears the group ID of a z_bmqa_Message object.
 * 
 * This function clears the group ID of the z_bmqa_Message object 'message'.
 * 
 * @param message A pointer to a z_bmqa_Message object.
 * 
 * @return Returns 0 upon successful operation.
 */
int z_bmqa_Message__clearGroupId(z_bmqa_Message* message);
 ...
 * 
 * This function creates a copy of the z_bmqa_Message object 'message' and stores
 * it in the memory pointed to by 'other_obj'.
 * 
 * @param message A pointer to a const z_bmqa_Message object to be copied.
 ...
 */
int z_bmqa_Message__clone(const z_bmqa_Message* message,
                          z_bmqa_Message**      other_obj);

/**
 * @brief Retrieves the queue ID from a z_bmqa_Message object.
 * 
 * This function retrieves the queue ID from the z_bmqa_Message object 'message'
 * and stores it in the memory pointed to by 'queueId_obj'.
 * 
 * @param message A pointer to a const z_bmqa_Message object.
 ...
 */
int z_bmqa_Message__queueId(const z_bmqa_Message*  message,
                            const z_bmqa_QueueId** queueId_obj);

/**
 * @brief Retrieves the correlation ID from a z_bmqa_Message object.
 * 
 * This function retrieves the correlation ID from the z_bmqa_Message object 'message'
 ...
 * 
 * This function retrieves the subscription handle from the z_bmqa_Message object 'message'
 ...
 * 
 * This function retrieves the compression algorithm type from the z_bmqa_Message object 'message'.
 * 
 * @param message A pointer to a const z_bmqa_Message object.
 * 
...
z_bmqa_Message__compressionAlgorithmType(const z_bmqa_Message* message);
 ...
 * 
 * This function retrieves the group ID from the z_bmqa_Message object 'message'.
 * 
 * @param message A pointer to a const z_bmqa_Message object.
 * 
 * @return A pointer to a string representing the group ID.
 */
const char* z_bmqa_Message__groupId(const z_bmqa_Message* message);
 ...
 * 
 * This function retrieves the message GUID from the z_bmqa_Message object 'message'
 ...
 * @return Returns 0 upon successful retrieval.
 */
int z_bmqa_Message__messageGUID(const z_bmqa_Message*      message,
                                const z_bmqt_MessageGUID** messageGUID_obj);

/**
 * @brief Retrieves the confirmation cookie from a z_bmqa_Message object.
 * 
 * This function retrieves the confirmation cookie from the z_bmqa_Message object 'message'
 ...
 * 
 * This function retrieves the acknowledgment status from the z_bmqa_Message object 'message'.
 * 
 * @param message A pointer to a const z_bmqa_Message object.
 * 
 * @return The acknowledgment status of the message.
 */
int z_bmqa_Message__ackStatus(const z_bmqa_Message* message);

/**
 * @brief Retrieves the data from a z_bmqa_Message object.
 * 
 * This function retrieves the data from the z_bmqa_Message object 'message'
 ...
 * 
 * This function retrieves the size of the data from the z_bmqa_Message object 'message'.
 * 
 * @param message A pointer to a const z_bmqa_Message object.
 * 
 * @return The size of the data.
 */
int z_bmqa_Message__dataSize(const z_bmqa_Message* message);

/**
 * @brief Checks if a z_bmqa_Message object has properties.
 * 
 * This function checks if the z_bmqa_Message object 'message' has properties.
 * 
 * @param message A pointer to a const z_bmqa_Message object.
 * 
 * @return Returns true if the message has properties, false otherwise.
 */
bool z_bmqa_Message__hasProperties(const z_bmqa_Message* message);
 ...
 * 
 * This function checks if the z_bmqa_Message object 'message' has a group ID.
 * 
 * @param message A pointer to a const z_bmqa_Message object.
 * 
 * @return Returns true if the message has a group ID, false otherwise.
 */
bool z_bmqa_Message__hasGroupId(const z_bmqa_Message* message);
 ...
 * 
 * This function loads the properties from the z_bmqa_Message object 'message'
 ...
 */
int z_bmqa_Message__loadProperties(const z_bmqa_Message*     message,
