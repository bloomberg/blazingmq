...
int z_bmqa_Message__delete(z_bmqa_Message** message)
{
    ...
    BSLS_ASSERT(message != NULL);

    bmqa::Message* message_p = reinterpret_cast<bmqa::Message*>(*message);
    delete message_p;
    *message = NULL;
...
int z_bmqa_Message__create(z_bmqa_Message** message)
{
    ...
    *message = reinterpret_cast<z_bmqa_Message*>(message_p);
    return 0;
}
...
int z_bmqa_Message__setCorrelationId(z_bmqa_Message*             message,
