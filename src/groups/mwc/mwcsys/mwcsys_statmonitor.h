...
// mwcsys_statmonitor.h                                               -*-C++-*-
#ifndef INCLUDED_MWCSYS_STATMONITOR
#define INCLUDED_MWCSYS_STATMONITOR

//@PURPOSE: Provide a mechanism to monitor cpu, memory, and os stats.
//
//@CLASSES:
//  mwcsys::StatMonitor    : Mechanism to monitor cpu, memory, os stats.
//  mwcsys::StatMonitorUtil: Utility to access monitor cpu, memory, os stats.
//
//@DESCRIPTION: 'mwcsys::StatMonitor' provides a mechanism that takes snapshots
...
// reported by the 'getrusage' system call.  'mwcsys::StatMonitorUtil' provides
...
/// StatContext
///-----------
// Statistics are kept in a 'mwcst::StatContext' having a root level named
...
class StatMonitor {
  private:
    ...
    BALL_LOG_SET_CLASS_CATEGORY("MWCSYS.STATMONITOR");
  ...
  private:
    ...
    mwcst::StatContext d_systemStatContext;
    // The root statistic context

    bslma::ManagedPtr<mwcst::StatContext> d_cpuStatContext_mp;
    // StatContext for cpu stats

    bslma::ManagedPtr<mwcst::StatContext> d_memStatContext_mp;
    // StatContext for memory stats

    bslma::ManagedPtr<mwcst::StatContext> d_osStatContext_mp;
...
struct StatMonitorUtil {
  private:
    ...
    getSystemStat(const mwcst::StatContext& statContext,
                  int                       snapshotId,
                  int                       statId);
    ...
    ///
    ///   avg(value[0, snapshotId])
    static double getCpuStat(const mwcst::StatContext& statContext,
                             int                       snapshotId,
                             int                       statId);
    ...
    ///
    ///   max(value[0, snapshotId])
    static bsls::Types::Int64 getMemStat(const mwcst::StatContext& statContext,
                                         int                       snapshotId,
                                         int                       statId);
    ...
    ///   difference(value[0], value[snapshotId]).
    static bsls::Types::Int64
    getOperatingSystemStat(const mwcst::StatContext& statContext,
                           int                       snapshotId,
                           int                       statId);
  ...
  public:
    ...
    ///
    ///   avg(value[0, snapshotId])
    static double cpuSystem(const mwcst::StatContext& statContext,
                            int                       snapshotId);
    ...
    ///
    ///   avg(value[0, snapshotId])
    static double cpuUser(const mwcst::StatContext& statContext,
                          int                       snapshotId);
    ...
    ///
    ///   avg(value[0, snapshotId])
    static double cpuAll(const mwcst::StatContext& statContext,
                         int                       snapshotId);
    ...
    ///  max(value[0, snapshotId])
    static bsls::Types::Int64
    memResident(const mwcst::StatContext& statContext, int snapshotId);
    ...
    ///
    ///   max(value[0, snapshotId])
    static bsls::Types::Int64 memVirtual(const mwcst::StatContext& statContext,
                                         int                       snapshotId);
    ...
    ///   difference(value[0], value[snapshotId])
    static bsls::Types::Int64
    minorPageFaults(const mwcst::StatContext& statContext, int snapshotId);
    ...
    ///   difference(value[0], value[snapshotId])
    static bsls::Types::Int64
    majorPageFaults(const mwcst::StatContext& statContext, int snapshotId);
    ...
    ///
    ///    difference(value[0], value[snapshotId]).
    static bsls::Types::Int64 numSwaps(const mwcst::StatContext& statContext,
                                       int                       snapshotId);
    ...
    ///    difference(value[0], value[snapshotId]).
    static bsls::Types::Int64
    voluntaryContextSwitches(const mwcst::StatContext& statContext,
                             int                       snapshotId);
    ...
    ///    difference(value[0], value[snapshotId]).
    static bsls::Types::Int64
    involuntaryContextSwitches(const mwcst::StatContext& statContext,
                               int                       snapshotId);
};
