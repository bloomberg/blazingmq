...
typedef bsl::function<
    double(const mwcst::StatContext& statCtx, int snapshotId, int statId)>
    AccessorDouble;
typedef bsl::function<bsls::Types::Int64(const mwcst::StatContext& statCtx,
                                         int                       snapshotId,
                                         int                       statId)>
    AccessorInt64;
...
double genericAccessor(const mwcst::StatContext& statContext,
                       int                       snapshotId,
                       const bslstl::StringRef&  subCtxName,
                       int                       statId,
                       const AccessorDouble&     accessorMethod)
{
    const mwcst::StatContext* subContext = statContext.getSubcontext(
        subCtxName);
    if (!subContext) {
...
/// the specified `accessorMethod` to extract this value. The behaviour for
/// invalid stat contexts or invalid names is undefined.
bsls::Types::Int64 genericAccessor(const mwcst::StatContext& statContext,
                                   int                       snapshotId,
                                   const bslstl::StringRef&  subCtxName,
                                   int                       statId,
...
mwcst::StatContext* StatMonitor::statContext()
{
...
bsls::Types::Int64
StatMonitorUtil::getSystemStat(const mwcst::StatContext& statContext,
                               int                       snapshotId,
                               int                       statId)
{
    ...
    const bsls::Types::Int64 value = mwcst::StatUtil::rangeMax(
        ...
        mwcst::StatValue::SnapshotLocation(0, snapshotId));
...
double StatMonitorUtil::getCpuStat(const mwcst::StatContext& statContext,
                                   int                       snapshotId,
                                   int                       statId)
{
    const mwcst::StatValue::SnapshotLocation firstSnapshot(0, 0);
...
bsls::Types::Int64
StatMonitorUtil::getMemStat(const mwcst::StatContext& statContext,
                            int                       snapshotId,
                            int                       statId)
{
    const mwcst::StatValue& statValue =
...
bsls::Types::Int64
StatMonitorUtil::getOperatingSystemStat(const mwcst::StatContext& statContext,
                                        int                       snapshotId,
                                        int                       statId)
{
    const mwcst::StatValue& statValue =
...
#define ACCESSOR_METHOD_CPU(NAME, ID)                                         \
    double StatMonitorUtil::NAME(const mwcst::StatContext& statContext,       \
                                 int                       snapshotId)        \
    {                                                                         \
