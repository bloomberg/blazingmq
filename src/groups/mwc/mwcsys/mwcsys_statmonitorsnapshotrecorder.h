...
// mwcsys_statmonitorsnapshotrecorder.h                               -*-C++-*-
#ifndef INCLUDED_MWCSYS_STATMONITORSNAPSHOTRECORDER
#define INCLUDED_MWCSYS_STATMONITORSNAPSHOTRECORDER

//@PURPOSE: Provide a mechanism to record snapshot of time, cpu, ctx switch.
//
//@CLASSES:
//  mwcsys::StatMonitorSnapshotRecorder: Mechanism to record snapshot of stats
//
//@DESCRIPTION: 'mwcsys::StatMonitorSnapshotRecorder' provides a mechanism to
...
//
// In this example, the 'mwcsys::StatMonitorSnapshotRecorder' is created on the
...
//  {
//      ...
//      mwcsys::StatMonitorSnapshotRecorder statRecorder(
//                                                    "Cluster (testCluster)");
...
class StatMonitorSnapshotRecorder {
  private:
    ...
    BALL_LOG_SET_CLASS_CATEGORY("MWCSYS.STATMONITORSNAPSHOTRECORDER");
  ...
  public:
    ...
    /// Create a new `mwcsys::StatMonitorSnapshotRecorder` using the
    ...
    /// Copy constructor, create a new `mwcsys::StatMonitorSnapshotRecorder`
