...
{
    mwctst::TestHelper::printTestName("RESOLVE UTILITIES - BREATHING TEST");
...

    {
        ...
        ntsa::Error error = mwcio::ResolveUtil::getIpAddress(&hostIp,
                                                             hostname);
...

    {
        ...
        ntsa::Error error = mwcio::ResolveUtil::getDomainName(
            &domainName,
...

    {
        ...
        ntsa::Error                  error =
            mwcio::ResolveUtil::getIpAddress(&addresses, "www.wikipedia.org");
...

    {
        ...
        bsl::vector<ntsa::IpAddress> addresses(s_allocator_p);
        ntsa::Error error = mwcio::ResolveUtil::getLocalIpAddress(&addresses);
