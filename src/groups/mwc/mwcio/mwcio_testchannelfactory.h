...
// mwcio_testchannelfactory.h                                         -*-C++-*-
#ifndef INCLUDED_MWCIO_TESTCHANNELFACTORY
#define INCLUDED_MWCIO_TESTCHANNELFACTORY

//@PURPOSE: Provide a test imp of the 'ChannelFactory' protocol
//
//@CLASSES:
// mwcio::TestChannelFactory
//
//@SEE_ALSO:
//
...
class TestChannelFactory : public ChannelFactory {
  ...
  private:
    ...
    mwct::PropertyBag            d_newHandleProperties;
