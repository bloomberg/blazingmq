...
// mwcio_testchannelfactory.cpp                                       -*-C++-*-
#include <mwcio_testchannelfactory.h>
...
mwct::PropertyBag& TestChannelFactoryOpHandle::properties()
{
    return d_properties;
}

const mwct::PropertyBag& TestChannelFactoryOpHandle::properties() const
{
    return d_properties;
}
...
mwct::PropertyBag& TestChannelFactory::newHandleProperties()
{
