...
// mwcio_resolveutil.h                                                -*-C++-*-
#ifndef INCLUDED_MWCIO_RESOLVEUTIL
#define INCLUDED_MWCIO_RESOLVEUTIL

//@PURPOSE: Provide utilities to resolve names to IP addresses.
//
//@CLASSES:
//  mwcio::ResolveUtil: Utility to resolve names to IP addresses.
//
//@DESCRIPTION: This component provides an utility, 'mwcio::ResolveUtil', to
