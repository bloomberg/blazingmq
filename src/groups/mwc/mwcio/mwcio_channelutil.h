...
// mwcio_channelutil.h                                                -*-C++-*-
#ifndef INCLUDED_MWCIO_CHANNELUTIL
#define INCLUDED_MWCIO_CHANNELUTIL

//@PURPOSE: Provide utility functions related to channel manipulation.
//
//@CLASSES:
//  mwcio::ChannelUtil: namespace for channel manipulation utility  functions.
//
//@DESCRIPTION: 'mwcio::ChannelUtil' provides a utility namespace for channel
