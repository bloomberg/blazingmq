...
// mwcio_listenoptions.h                                              -*-C++-*-
#ifndef INCLUDED_MWCIO_LISTENOPTIONS
#define INCLUDED_MWCIO_LISTENOPTIONS

//@PURPOSE: Provide a type encapsulating options for 'ChannelFactory::listen'.
//
//@CLASSES:
//  mwcio::ListenOptions: type encapsulating 'ChannelFactory::listen' options
//
//@DESCRIPTION: This component defines a value-semantic type,
// 'mwcio::ListenOptions', which encapsulates various listen options
// passed to 'mwcio::ChannelFactory::listen'.
...
/// Listen options used when calling `mwcio::ChannelFactory::listen`.
class ListenOptions {
  private:
    // DATA
...
inline mwct::PropertyBag& ListenOptions::properties()
{
    return d_properties;
}
...
inline const mwct::PropertyBag& ListenOptions::properties() const
{
    return d_properties;
}
