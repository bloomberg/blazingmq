...
// mwcio_statchannel.h                                                -*-C++-*-
#ifndef INCLUDED_MWCIO_STATCHANNEL
#define INCLUDED_MWCIO_STATCHANNEL

//@PURPOSE: Provide a 'mwcio::Channel' that collects stats.
//
//@CLASSES:
// mwcio::StatChannel
// mwcio::StatChannelConfig
//
//@SEE_ALSO:
//
//@DESCRIPTION: This component defines a mechanism, 'mwcio::StatChannel', which
// is a concrete implementation of the 'mwcio::Channel' protocol that collects
// stats.
