...
// mwcio_reconnectingchannelfactory.h                                 -*-C++-*-
#ifndef INCLUDED_MWCIO_RECONNECTINGCHANNELFACTORY
#define INCLUDED_MWCIO_RECONNECTINGCHANNELFACTORY

//@PURPOSE: Provide an auto-reconnecting ChannelFactory decorator
//
//@CLASSES:
// mwcio::ReconnectingChannelFactory
...
// 'mwcio::ReconnectingChannelFactory', which is a decorator of a base
// 'mwcio::ChannelFactory' that gives it the ability to automatically retry a
...
: public ChannelFactory::OpHandle {
  public:
    // PUBLIC DATA
    mwcu::AtomicValidator d_validator;
