...
// mwcio_channelfactory.h                                             -*-C++-*-
#ifndef INCLUDED_MWCIO_CHANNELFACTORY
#define INCLUDED_MWCIO_CHANNELFACTORY

//@PURPOSE: Provide a protocol for a 'mwcio::Channel' factory.
//
//@CLASSES:
//  mwcio::ChannelFactory:      protocol for a 'mwcio::Channel' factory
//  mwcio::ChannelFactoryEvent: event type for connec/listen notifications
//
//@SEE_ALSO:
//  mwcio_channel
//  mwcio_channeldecorator
//
//@DESCRIPTION: This component defines a pure protocol,
// 'mwcio::ChannelFactory', which is a factory of objects that implement the
// 'mwcio::Channel' protocol.  It also provides an enum,
// 'mwcio::ChannelFactoryEvent' for categorizing the various events
...
/// operations on the `mwcio::ChannelFactory` object.
struct ChannelFactoryEvent {
    // TYPES
    enum Enum {
        e_CHANNEL_UP             = 1,
...
/// Protocol for a factory of `mwcio::Channel` objects.
class ChannelFactory {
  public:
    // PUBLIC TYPES
...
inline bsl::ostream& mwcio::operator<<(bsl::ostream&                    stream,
                                       mwcio::ChannelFactoryEvent::Enum value)
{
