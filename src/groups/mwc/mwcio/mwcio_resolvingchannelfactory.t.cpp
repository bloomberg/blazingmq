...
// mwcio_resolvingchannelfactory.t.cpp                                -*-C++-*-
...
class TestExecutor {
  ...
  public:
    ...
    bool operator==(const TestExecutor& rhs) const
    {
        ...
        //       Executor concept as defined in 'mwcex' package documentation.
...
// ------------------------------------------------------------------------
{
    ...
    mwcio::TestChannel base(s_allocator_p);
...
// ------------------------------------------------------------------------
{
    ...
    ResolvingChannelFactoryConfig cfg(
        &baseFactory,
        mwcex::ExecutionPolicyUtil::oneWay().neverBlocking().useExecutor(
