...
// mwcio_resolvingchannelfactory.h                                    -*-C++-*-
#ifndef INCLUDED_MWCIO_RESOLVINGCHANNELFACTORY
#define INCLUDED_MWCIO_RESOLVINGCHANNELFACTORY

//@PURPOSE: Provide a 'ChannelFactory' that resolves the URIs of its channels
//
//@CLASSES:
// mwcio::ResolvingChannelFactory
//
//@SEE_ALSO:
//
//@DESCRIPTION: This component defines a mechanism,
// 'mwcio::ResolvingChannelFactory', which is an implementation of the
// 'mwcio::ChannelFactory' protocol that resolves the 'peerUri' of the channels
// created by a base 'mwcio::ChannelFactory' and updates them on its channels
// dynamically.
...
#include <mwcio_decoratingchannelpartialimp.h>
...
class ResolvingChannelFactory : public ChannelFactory {
  ...
  private:
    ...
    mutable mwcu::SharedResource<ResolvingChannelFactory> d_self;
...
struct ResolvingChannelFactoryUtil {
    ...
    /// `mwcio::ResolveUtil::getDomainName` then load into the specified
