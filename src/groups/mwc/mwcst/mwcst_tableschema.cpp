...
// FUNCTIONS
void intFuncWrapper(mwcst::Value*          value,
...
void doubleFuncWrapper(mwcst::Value*          value,
                       const StatContext&     context,
                       StatContext::ValueType type,
                       int                    statIndex,
                       const DoubleFunc&      fn)
...
void defaultIdColumn(mwcst::Value*          value,
                     const StatContext&     context,
                     int                    level,
                     StatContext::ValueType type)
{
...
void TableSchemaColumn::evaluate(mwcst::Value*          value,
                                 const StatContext&     context,
                                 int                    level,
