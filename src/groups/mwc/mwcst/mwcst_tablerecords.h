...
// mwcst_tablerecords.h                                               -*-C++-*-
#ifndef INCLUDED_MWCST_TABLERECORDS
#define INCLUDED_MWCST_TABLERECORDS

//@PURPOSE: Provide a container for records in a Stat Context.
//
//@CLASSES:
// mwcst::TableRecordsRecord : An individual record.
// mwcst::TableRecord        : Records of a 'mwcst::StatContext' table.
//
//@SEE_ALSO: mwcst_statcontext
//           mwcst_table
//
//@DESCRIPTION: This component provides a mechanism for accessing and filtering
// or sorting records in a 'mwcst::Table' associated with a
// 'mwcst::StatContext'.
//
...
/// A record in a `mwcst::TableRecords`.
class TableRecordsRecord {
  private:
    // DATA
...
/// Records of a `mwcst::StatContext` table.
class TableRecords {
  public:
    // PUBLIC TYPES
