...
// mwctst_scopedlogobserver.t.cpp                                     -*-C++-*-
...
//   setSeverityThreshold
{
    ...
    mwctst::ScopedLogObserver observer(ball::Severity::OFF, s_allocator_p);
...
//   publish
{
    mwctst::TestHelper::printTestName("PUBLISH");
...
//   publish
{
    mwctst::TestHelper::printTestName("RECORD MESSAGE MATCH");
    ...
    for (size_t idx = 0; idx < k_NUM_DATA; ++idx) {
        ...
        ASSERT_EQ(
            mwctst::ScopedLogObserverUtil::recordMessageMatch(record,
                                                              test.d_pattern,
                                                              s_allocator_p),
            test.d_isMatch);
    }
