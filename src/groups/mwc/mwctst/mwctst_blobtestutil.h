...
// mwctst_blobtestutil.h                                              -*-C++-*-
#ifndef INCLUDED_MWCTST_BLOBTESTUTIL
#define INCLUDED_MWCTST_BLOBTESTUTIL

//@PURPOSE: Provide blob utilities for use in test drivers.
//
//@CLASSES:
//  mwctst::BlobTestUtil: namespace for a set of blob utilities
//
//@DESCRIPTION: 'mwctst::BlobTestUtil' provides a set of blob utilities to
...
//  ASSERT_EQ("abcdefg", mwctst::BlobTestUtil::toString(&str, blob));
//..
