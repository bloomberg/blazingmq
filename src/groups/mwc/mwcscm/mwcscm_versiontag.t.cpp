...
int main(int argc, char** argv)
{
    ...
    case 1: {
        ...
        BSLIM_TESTUTIL_ASSERT(MWC_VERSION_MAJOR ==
                              (MWC_VERSION / 10000) % 100);
        BSLIM_TESTUTIL_ASSERT(MWC_VERSION_MINOR == (MWC_VERSION / 100) % 100);
        BSLIM_TESTUTIL_ASSERT(0 == MWC_VERSION % 100);
        ...
        BSLIM_TESTUTIL_ASSERT(MWC_EXT_VERSION == 999999);
    } break;
