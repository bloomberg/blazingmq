...
// mwcu_samethreadchecker.h                                           -*-C++-*-
#ifndef INCLUDED_MWCU_SAMETHREADCHECKER
...
//
//@DESCRIPTION:
// This component provides a mechanism, 'mwcu::SameThreadChecker', to check if
// a function call is always performed in the same thread.
//
/// Thread safety
///-------------
// 'mwcu::SameThreadChecker' is fully thread-safe, meaning that multiple
...
//
//      mwcu::SameThreadChecker  d_ioThreadChecker;
