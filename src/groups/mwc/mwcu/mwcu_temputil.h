...
// mwcu_temputil.h                                                    -*-C++-*-
#ifndef INCLUDED_MWCU_TEMPUTIL
#define INCLUDED_MWCU_TEMPUTIL

//@PURPOSE: Provide an utility for resolving the effective temporary directory.
//
//@CLASSES:
//  mwcu::TempUtil: Utilities for temporary directories and files.
//
//@DESCRIPTION: This component provides an utility, 'mwcu::TempUtil', to
