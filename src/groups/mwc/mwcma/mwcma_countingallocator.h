...
class CountingAllocator BSLS_KEYWORD_FINAL : public bslma::Allocator {
  ...
  public:
    ...
    ///
    /// @deprecated Use the version taking a `mwcst::Table` and
    /// `mwcu::BasicTableInfoProvider` instead.
    BSLA_DEPRECATED static void configureStatContextTableInfoProvider(
