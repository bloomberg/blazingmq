...
// mwct_rcdescriptionerror.h                                          -*-C++-*-
#ifndef INCLUDED_MWCT_RCDESCRIPTIONERROR
#define INCLUDED_MWCT_RCDESCRIPTIONERROR

//@PURPOSE: Provide a value-semantic class for a typical error.
//
//@CLASSES:
//  mwct::RcDescriptionError: An error type with an 'int' and a 'bsl::string'
//
//@DESCRIPTION: The 'mwct::RcDescriptionError' provides a type that represents
