...
// mwct_rcdescriptionerror.t.cpp                                      -*-C++-*-
...
// ------------------------------------------------------------------------
{
...

    {
        ...
        mwct::RcDescriptionError obj(s_allocator_p);
        ASSERT_EQ(obj.rc(), 0);
...

    {
        ...
        mwct::RcDescriptionError obj(123, "abc", s_allocator_p);
...

    {
        ...
        mwct::RcDescriptionError copy(obj, s_allocator_p);
        ASSERT_EQ(copy.rc(), 123);
        ASSERT_EQ(copy.description(), "abc");

        mwct::RcDescriptionError assignment(987, "zyx", s_allocator_p);
        assignment = obj;
...
// ------------------------------------------------------------------------
{
    mwctst::TestHelper::printTestName("EQUALITY");
    ...
    for (size_t idx = 0; idx < k_NUM_DATA; ++idx) {
        ...
        mwct::RcDescriptionError lhs(test.d_lrc,
                                     test.d_ldescription,
                                     s_allocator_p);
        mwct::RcDescriptionError rhs(test.d_rrc,
                                     test.d_rdescription,
                                     s_allocator_p);
...
// ------------------------------------------------------------------------
{
...

    {
        ...
        mwct::RcDescriptionError::print(os, obj, 0, 0);
        ASSERT_EQ(os.str(), "[\nrc = 123\ndescription = \"abc\"\n]\n");
    }
