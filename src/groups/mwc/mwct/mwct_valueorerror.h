...
// mwct_valueorerror.h                                                -*-C++-*-
#ifndef INCLUDED_MWCT_VALUEORERROR
#define INCLUDED_MWCT_VALUEORERROR

//@PURPOSE: Provide a value-semantic class that may hold a value or an error.
//
//@CLASSES:
//  mwct::ValueOrError: Represents a Value or Error type.
//
//@DESCRIPTION: The 'mwct::ValueOrError' provides a type that abstracts a wide
...
// functions.
//
// 'mwct::ValueOrError' aims to be used in the following way:
//
//..
//  struct ErrorsForFoo {
//      enum Type {
...
template <class VALUE, class ERROR>
inline bsl::ostream&
mwct::operator<<(bsl::ostream&                           stream,
                 const mwct::ValueOrError<VALUE, ERROR>& value)
{
