...
{
    mwctst::TestHelper::printTestName("Copy and Assignment");
...
static void test3_print()
{
    ...
    // We can't use 'mwcu::MemOutStream' because mwcu is above mwct, so use
...
{
    mwctst::TestHelper::printTestName("loadAll/import");
...
{
    mwctst::TestHelper::printTestName("PropertyBagUtil");
...
{
    mwctst::TestHelper::printTestName("ValueOverwrite");
