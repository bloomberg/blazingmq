...
// mwcex_bdlmtfixedthreadpoolexecutor.t.cpp                           -*-C++-*-
...
//
// Plan:
//   Construct an instance of 'mwcex::BdlmtFixedThreadPoolExecutor' and
//   check postconditions.
//
// Testing:
//   mwcex::BdlmtFixedThreadPoolExecutor's constructor
// ------------------------------------------------------------------------
{
    ...
    // create executor
    mwcex::BdlmtFixedThreadPoolExecutor ex(&threadPool);
...
//
// Testing:
//   mwcex::BdlmtFixedThreadPoolExecutor::post
// ------------------------------------------------------------------------
{
    bslma::TestAllocator   alloc;
    bdlmt::FixedThreadPool threadPool(1,  // numThreads
...
//
// Testing:
//   mwcex::BdlmtFixedThreadPoolExecutor::swap
// ------------------------------------------------------------------------
{
    bslma::TestAllocator   alloc;
    ...
    // create executor
    mwcex::BdlmtFixedThreadPoolExecutor ex1(&threadPool1);
    mwcex::BdlmtFixedThreadPoolExecutor ex2(&threadPool2);
...
//
// Testing:
//   mwcex::BdlmtFixedThreadPoolExecutor::context
// ------------------------------------------------------------------------
{
    bslma::TestAllocator   alloc;
    bdlmt::FixedThreadPool threadPool1(1,  // numThreads
...
//
// Testing:
//   mwcex::BdlmtFixedThreadPoolExecutor's equality comparison operator
//   mwcex::BdlmtFixedThreadPoolExecutor's inequality comparison operator
// ------------------------------------------------------------------------
{
    bslma::TestAllocator   alloc;
    bdlmt::FixedThreadPool threadPool1(1,  // numThreads
    ...
    // equality
    {
        ASSERT_EQ(mwcex::BdlmtFixedThreadPoolExecutor(&threadPool1) ==
                      mwcex::BdlmtFixedThreadPoolExecutor(&threadPool1),
                  true);

        ASSERT_EQ(mwcex::BdlmtFixedThreadPoolExecutor(&threadPool1) ==
                      mwcex::BdlmtFixedThreadPoolExecutor(&threadPool2),
                  false);
    }
