...
// mwcex_bdlmtmultiprioritythreadpoolexecutor.h                       -*-C++-*-
#ifndef INCLUDED_MWCEX_BDLMTMULTIPRIORITYTHREADPOOLEXECUTOR
#define INCLUDED_MWCEX_BDLMTMULTIPRIORITYTHREADPOOLEXECUTOR
...
// 'mwcex::BdlmtMultipriorityThreadPoolExecutor', that is an executor adapter
// for 'bdlmt::MultipriorityThreadPool'.
//
/// Thread safety
///-------------
// With the exception of assignment operators, as well as the 'swap' member
// function, 'mwcex::BdlmtMultipriorityThreadPoolExecutor' is fully thread-
...
// the adapter with the 'mwcex' package. For example:
//..
//  // create an executor
//  mwcex::BdlmtMultipriorityThreadPoolExecutor ex(&d_threadPool, d_priority);
//
//  // use it
...
// FREE OPERATORS
inline bool mwcex::operator==(const BdlmtMultipriorityThreadPoolExecutor& lhs,
                              const BdlmtMultipriorityThreadPoolExecutor& rhs)
    BSLS_KEYWORD_NOEXCEPT
{
    return &lhs.context() == &rhs.context() &&
...
inline void
mwcex::swap(BdlmtMultipriorityThreadPoolExecutor& lhs,
            BdlmtMultipriorityThreadPoolExecutor& rhs) BSLS_KEYWORD_NOEXCEPT
{
    lhs.swap(rhs);
}
