...
// mwcex_bdlmtmultiqueuethreadpoolexecutor.t.cpp                      -*-C++-*-
...
//
// Plan:
//   Construct an instance of 'mwcex::BdlmtMultiQueueThreadPoolExecutor'
//   and check postconditions.
//
// Testing:
//   mwcex::BdlmtMultiQueueThreadPoolExecutor's constructor
// ------------------------------------------------------------------------
{
    ...
    // create executor
    mwcex::BdlmtMultiQueueThreadPoolExecutor ex(&threadPool,
                                                42);  // queueId
...
//
// Testing:
//   mwcex::BdlmtMultiQueueThreadPoolExecutor::post
//   mwcex::BdlmtMultiQueueThreadPoolExecutor::dispatch
// ------------------------------------------------------------------------
{
    ...
    // create executors
    mwcex::BdlmtMultiQueueThreadPoolExecutor ex1(&threadPool, queue1Id);
    mwcex::BdlmtMultiQueueThreadPoolExecutor ex2(&threadPool, queue2Id);
...
//
// Testing:
//   mwcex::BdlmtMultiQueueThreadPoolExecutor::swap
// ------------------------------------------------------------------------
{
    bslma::TestAllocator        alloc;
    ...
    // create executors
    mwcex::BdlmtMultiQueueThreadPoolExecutor ex1(&threadPool1,
                                                 1);  // queueId
    mwcex::BdlmtMultiQueueThreadPoolExecutor ex2(&threadPool2,
                                                 2);  // queueId
...
//
// Testing:
//   mwcex::BdlmtMultiQueueThreadPoolExecutor::context
// ------------------------------------------------------------------------
{
    bslma::TestAllocator        alloc;
    bdlmt::MultiQueueThreadPool threadPool1(bslmt::ThreadAttributes(),
...
//
// Testing:
//   mwcex::BdlmtMultiQueueThreadPoolExecutor::queueId
// ------------------------------------------------------------------------
{
    bslma::TestAllocator        alloc;
    bdlmt::MultiQueueThreadPool threadPool(bslmt::ThreadAttributes(),
    ...
    mwcex::BdlmtMultiQueueThreadPoolExecutor ex1(&threadPool,
                                                 1);  // queueId
    ASSERT_EQ(ex1.queueId(), 1);

    mwcex::BdlmtMultiQueueThreadPoolExecutor ex2(&threadPool,
                                                 2);  // queueId
...
//
// Testing:
//   mwcex::BdlmtMultiQueueThreadPoolExecutor::rebindQueueId
// ------------------------------------------------------------------------
{
    bslma::TestAllocator        alloc;
    bdlmt::MultiQueueThreadPool threadPool(bslmt::ThreadAttributes(),
    ...
    mwcex::BdlmtMultiQueueThreadPoolExecutor ex2 = ex1.rebindQueueId(2);
...
//
// Testing:
//   mwcex::BdlmtMultiQueueThreadPoolExecutor's equality comp. operator
...
// ------------------------------------------------------------------------
{
    ...
    // equality
    {
        ASSERT_EQ(mwcex::BdlmtMultiQueueThreadPoolExecutor(&threadPool1, 1) ==
                      mwcex::BdlmtMultiQueueThreadPoolExecutor(&threadPool1,
                                                               1),
                  true);

        ASSERT_EQ(mwcex::BdlmtMultiQueueThreadPoolExecutor(&threadPool1, 1) ==
                      mwcex::BdlmtMultiQueueThreadPoolExecutor(&threadPool2,
                                                               1),
                  false);
