...
// mwcex_sequentialcontext.t.cpp                                      -*-C++-*-
...
//
// Plan:
//   Default-construct an instance of 'mwcex::SequentialContext'. Check
//   postconditions. Destroy the object and check that no memory is leaked.
//
// Testing:
//   mwcex::SequentialContext's constructor
//   mwcex::SequentialContext's destructor
// ------------------------------------------------------------------------
{
    bslma::TestAllocator alloc;

    // create context
    mwcex::SequentialContext ctx(&alloc);
...
//
// Testing:
//   mwcex::SequentialContext::dropPendingJobs
// ------------------------------------------------------------------------
{
    bslma::TestAllocator alloc;
...
//     'mwcex::SequentialContext' via the 'mwcex::SequentialContext's
//     executor, but not yet invoked;
//   - The number of function objects that are currently being invoked
//     within the 'mwcex::SequentialContext'.
//
// Testing:
//   mwcex::SequentialContext::outstandingJobs
// ------------------------------------------------------------------------
{
    static const int NUM_JOBS = 10;
...
//
// Testing:
//   mwcex::SequentialContextExecutor::post
// ------------------------------------------------------------------------
{
    bslma::TestAllocator alloc;
...
//
// Testing:
//   mwcex::SequentialContextExecutor::dispatch
// ------------------------------------------------------------------------
{
    bslma::TestAllocator alloc;
...
//
// Testing:
//   mwcex::SequentialContextExecutor::swap
// ------------------------------------------------------------------------
{
    bslma::TestAllocator     alloc;
    mwcex::SequentialContext ctx1(&alloc), ctx2(&alloc);

    mwcex::SequentialContextExecutor ex1 = ctx1.executor();
    mwcex::SequentialContextExecutor ex2 = ctx2.executor();
...
//
// Testing:
//   mwcex::SequentialContextExecutor::runningInThisThread
// ------------------------------------------------------------------------
{
    typedef mwcex::SequentialContextExecutor ExecutorType;
...
//   associated 'mwcex::SequentialContext' object.
//
// Testing:
//   mwcex::SequentialContextExecutor::context
// ------------------------------------------------------------------------
{
    bslma::TestAllocator     alloc;
    mwcex::SequentialContext ctx1(&alloc), ctx2(&alloc);
...
int main(int argc, char* argv[])
{
    ...
    // mwcex::SequentialContextExecutor
