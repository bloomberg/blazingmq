...
// mwcex_bdlmteventschedulerexecutor.h                                -*-C++-*-
#ifndef INCLUDED_MWCEX_BDLMTEVENTSCHEDULEREXECUTOR
#define INCLUDED_MWCEX_BDLMTEVENTSCHEDULEREXECUTOR
...
//
//@DESCRIPTION:
// This component provides a class, 'mwcex::BdlmtEventSchedulerExecutor', that
// is an executor adapter for 'bdlmt::EventScheduler'.
//
/// Thread safety
///-------------
// With the exception of assignment operators, as well as the 'swap' member
// function, 'mwcex::BdlmtEventSchedulerExecutor' is fully thread-safe, meaning
...
// scheduler, and use the adapter with the 'mwcex' package.  For example:
//..
//  // create an executor
//  mwcex::BdlmtEventSchedulerExecutor ex(&d_eventScheduler);
//
//  // use it
...
//  mwcex::BdlmtEventSchedulerExecutor ex(
//                       &d_eventScheduler,
...
// scheduler.
//
// 'mwcex::BdlmtEventSchedulerExecutor' also provides a convenient
...
// FREE OPERATORS
inline bool
mwcex::operator==(const BdlmtEventSchedulerExecutor& lhs,
                  const BdlmtEventSchedulerExecutor& rhs) BSLS_KEYWORD_NOEXCEPT
{
    return &lhs.context() == &rhs.context() &&
           lhs.timePoint() == rhs.timePoint();
...
inline void mwcex::swap(BdlmtEventSchedulerExecutor& lhs,
                        BdlmtEventSchedulerExecutor& rhs) BSLS_KEYWORD_NOEXCEPT
{
    lhs.swap(rhs);
}
