...
// mwcex_bdlmtthreadpoolexecutor.h                                    -*-C++-*-
#ifndef INCLUDED_MWCEX_BDLMTTHREADPOOLEXECUTOR
#define INCLUDED_MWCEX_BDLMTTHREADPOOLEXECUTOR
...
//
//@DESCRIPTION:
// This component provides a class, 'mwcex::BdlmtThreadPoolExecutor', that is
// an executor adapter for 'bdlmt::ThreadPool'.
//
/// Thread safety
///-------------
// With the exception of assignment operators, as well as the 'swap' member
// function, 'mwcex::BdlmtThreadPoolExecutor' is fully thread-safe, meaning
...
//..
//  // create an executor
//  mwcex::BdlmtThreadPoolExecutor ex(&d_threadPool);
//
//  // use it
...
// FREE OPERATORS
inline bool
mwcex::operator==(const BdlmtThreadPoolExecutor& lhs,
                  const BdlmtThreadPoolExecutor& rhs) BSLS_KEYWORD_NOEXCEPT
{
    return &lhs.context() == &rhs.context();
}
...
inline void mwcex::swap(BdlmtThreadPoolExecutor& lhs,
                        BdlmtThreadPoolExecutor& rhs) BSLS_KEYWORD_NOEXCEPT
{
    lhs.swap(rhs);
}
