...
//
// Plan:
//   Create a bind wrapper via a call to 'mwcex::BindUtil::bindExecute'
...
// ------------------------------------------------------------------------
{
    ...
    bsl::function<void()> wrapper(
        ...
        &alloc,
        mwcex::BindUtil::bindExecute(
            mwcex::ExecutionPolicyUtil::defaultPolicy().useAllocator(&alloc),
...
//
// Testing:
//   mwcex::BindUtil::BindUtil_BindWrapper init constructor
//   mwcex::BindUtil::BindUtil_BindWrapper copy constructor
//   mwcex::BindUtil::BindUtil_BindWrapper move constructor
// ------------------------------------------------------------------------
{
    typedef mwcex::BindUtil_BindWrapper<mwcex::ExecutionPolicy<>,
                                        SetFlagOnCall>
        BindWrapper;
...
//
// Testing:
//   mwcex::BindUtil::BindUtil_BindWrapper::operator()
// ------------------------------------------------------------------------
{
    typedef mwcex::BindUtil_BindWrapper<mwcex::ExecutionPolicy<>,
