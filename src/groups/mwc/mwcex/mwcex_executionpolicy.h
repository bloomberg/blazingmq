...
// mwcex_executionpolicy.h                                            -*-C++-*-
#ifndef INCLUDED_MWCEX_EXECUTIONPOLICY
#define INCLUDED_MWCEX_EXECUTIONPOLICY

//@PURPOSE: Provides an execution policy to customize execution functions.
//
//@CLASSES:
//  mwcex::ExecutionPolicy:     an execution policy
//  mwcex::ExecutionPolicyUtil: a namespace for factory functions
//
//@SEE ALSO:
//  mwcex_executionutil
//
...
// 'mwcex_executionutil' component. A policy object contains the following
// properties:
...
// 'mwcex_executionutil' component that provides a set of execution functions
// named 'execute', defined in the 'mwcex::ExecutionUtil' namespace. 'execute'
...
// object invocation, via a 'mwcex::Future' object. The exact type of the
// execution function return value can be obtained at compile time using the
// 'mwcex::ExecutionUtil::ExecuteResult' metafunction (see
// 'mwcex_executionutil').
//
...
// the result of that operation. The 'mwcex::ExecutionUtil' namespace provides
...
// policy and a function object arguments, but also a 'mwcex::Future' object to
...
// operation encoded in a 'mwcex::FutureResult' object. If the policy used is
// Two-Way policy, the caller of 'thenExecute' is returned a 'mwcex::Future'
...
// compile time using the 'mwcex::ExecutionUtil::ThenExecuteResult'
// metafunction (see 'mwcex_executionutil').
//..
//  using mwcex;
//
...
struct ExecutionPolicyUtil {
    ...
    /// Blocking policy using a default-constructed `mwcex::SystemExecutor`
