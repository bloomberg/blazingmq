...
// mwcex_bdlmtmultiqueuethreadpoolexecutor.h                          -*-C++-*-
#ifndef INCLUDED_MWCEX_BDLMTMULTIQUEUETHREADPOOLEXECUTOR
#define INCLUDED_MWCEX_BDLMTMULTIQUEUETHREADPOOLEXECUTOR
...
//
//@DESCRIPTION:
// This component provides a class, 'mwcex::BdlmtMultiQueueThreadPoolExecutor',
...
// function, 'mwcex::BdlmtMultiQueueThreadPoolExecutor' is fully thread-safe,
...
// 'mwcex' package. For example:
//..
//  // create an executor
//  mwcex::BdlmtMultiQueueThreadPoolExecutor ex(&d_threadPool, d_queueId);
//
//  // use it
...
// FREE OPERATORS
inline bool mwcex::operator==(const BdlmtMultiQueueThreadPoolExecutor& lhs,
                              const BdlmtMultiQueueThreadPoolExecutor& rhs)
    BSLS_KEYWORD_NOEXCEPT
{
...
inline void
mwcex::swap(BdlmtMultiQueueThreadPoolExecutor& lhs,
            BdlmtMultiQueueThreadPoolExecutor& rhs) BSLS_KEYWORD_NOEXCEPT
{
    lhs.swap(rhs);
}
