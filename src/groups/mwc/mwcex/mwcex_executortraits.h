...
// mwcex_executortraits.h                                             -*-C++-*-
#ifndef INCLUDED_MWCEX_EXECUTORTRAITS
#define INCLUDED_MWCEX_EXECUTORTRAITS
...
//
//@DESCRIPTION:
// This component provides a class template, 'mwcex::ExecutorTraits', to access
// various properties of Executors. Other components provided by the 'mwcex'
