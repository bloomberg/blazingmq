...
// mwcex_executionproperty.h                                          -*-C++-*-
#ifndef INCLUDED_MWCEX_EXECUTIONPROPERTY
#define INCLUDED_MWCEX_EXECUTIONPROPERTY

//@PURPOSE: Provides utility tag types to be used with 'mwcex::ExecutionPolicy'
//
//@CLASSES:
...
//
//@DESCRIPTION:
// This component provides a struct, 'mwcex::ExecutionProperty', that serves as
// a namespace for utility tag types and enumeration values to be used with
// 'mwcex::ExecutionPolicy' to specify the execution policy direction and
// blocking properties.
...
/// used with `mwcex::ExecutionPolicy` to specify the execution policy
