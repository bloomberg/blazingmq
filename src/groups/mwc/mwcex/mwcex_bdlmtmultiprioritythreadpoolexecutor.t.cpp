...
// mwcex_bdlmtmultiprioritythreadpoolexecutor.t.cpp                   -*-C++-*-
...
//
// Plan:
//   Construct an instance of 'mwcex::BdlmtMultipriorityThreadPoolExecutor'
//   and check postconditions.
//
// Testing:
//   mwcex::BdlmtMultipriorityThreadPoolExecutor's constructor
// ------------------------------------------------------------------------
{
    ...
    // create executor
    mwcex::BdlmtMultipriorityThreadPoolExecutor ex(&threadPool,
                                                   42);  // priority
...
//
// Testing:
//   mwcex::BdlmtMultipriorityThreadPoolExecutor::post
// ------------------------------------------------------------------------
{
    bslma::TestAllocator           alloc;
    bdlmt::MultipriorityThreadPool threadPool(1,  // numThreads
    ...
    mwcex::BdlmtMultipriorityThreadPoolExecutor ex1(&threadPool, 1);
    mwcex::BdlmtMultipriorityThreadPoolExecutor ex2(&threadPool, 0);
...
//
// Testing:
//   mwcex::BdlmtMultipriorityThreadPoolExecutor::swap
// ------------------------------------------------------------------------
{
    bslma::TestAllocator           alloc;
    ...
    // create executors
    mwcex::BdlmtMultipriorityThreadPoolExecutor ex1(&threadPool1,
                                                    1);  // priority
    mwcex::BdlmtMultipriorityThreadPoolExecutor ex2(&threadPool2,
                                                    2);  // priority
...
//
// Testing:
//   mwcex::BdlmtMultipriorityThreadPoolExecutor::context
// ------------------------------------------------------------------------
{
    bslma::TestAllocator           alloc;
    bdlmt::MultipriorityThreadPool threadPool1(1,  // numThreads
...
//
// Testing:
//   mwcex::BdlmtMultipriorityThreadPoolExecutor::priority
// ------------------------------------------------------------------------
{
    bslma::TestAllocator           alloc;
    bdlmt::MultipriorityThreadPool threadPool(1,  // numThreads
    ...
    mwcex::BdlmtMultipriorityThreadPoolExecutor ex1(&threadPool,
                                                    1);  // priority
    ASSERT_EQ(ex1.priority(), 1);

    mwcex::BdlmtMultipriorityThreadPoolExecutor ex2(&threadPool,
                                                    2);  // priority
...
//
// Testing:
//   mwcex::BdlmtMultipriorityThreadPoolExecutor::rebindPriority
// ------------------------------------------------------------------------
{
    bslma::TestAllocator           alloc;
    bdlmt::MultipriorityThreadPool threadPool(1,  // numThreads
    ...
    mwcex::BdlmtMultipriorityThreadPoolExecutor ex2 = ex1.rebindPriority(2);
...
//
// Testing:
//   mwcex::BdlmtMultipriorityThreadPoolExecutor's equality comp. op.
//   mwcex::BdlmtMultipriorityThreadPoolExecutor's inequality comp. op.
// ------------------------------------------------------------------------
{
    bslma::TestAllocator           alloc;
    bdlmt::MultipriorityThreadPool threadPool1(1,  // numThreads
    ...
    {
        ASSERT_EQ(
            mwcex::BdlmtMultipriorityThreadPoolExecutor(&threadPool1, 1) ==
                mwcex::BdlmtMultipriorityThreadPoolExecutor(&threadPool1, 1),
            true);

        ASSERT_EQ(
            mwcex::BdlmtMultipriorityThreadPoolExecutor(&threadPool1, 1) ==
                mwcex::BdlmtMultipriorityThreadPoolExecutor(&threadPool2, 1),
            false);

        ASSERT_EQ(
            mwcex::BdlmtMultipriorityThreadPoolExecutor(&threadPool1, 1) ==
                mwcex::BdlmtMultipriorityThreadPoolExecutor(&threadPool1, 2),
            false);
    }
