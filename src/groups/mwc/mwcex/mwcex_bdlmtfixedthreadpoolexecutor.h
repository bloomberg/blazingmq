...
// mwcex_bdlmtfixedthreadpoolexecutor.h                               -*-C++-*-
#ifndef INCLUDED_MWCEX_BDLMTFIXEDTHREADPOOLEXECUTOR
#define INCLUDED_MWCEX_BDLMTFIXEDTHREADPOOLEXECUTOR
...
//
//@DESCRIPTION:
// This component provides a class, 'mwcex::BdlmtFixedThreadPoolExecutor', that
// is an executor adapter for 'bdlmt::FixedThreadPool'.
//
/// Thread safety
///-------------
// With the exception of assignment operators, as well as the 'swap' member
// function, 'mwcex::BdlmtFixedThreadPoolExecutor' is fully thread-safe,
...
// use the adapter with the 'mwcex' package. For example:
//..
//  // create an executor
//  mwcex::BdlmtFixedThreadPoolExecutor ex(&d_threadPool);
//
//  // use it
...
// FREE OPERATORS
inline bool mwcex::operator==(const BdlmtFixedThreadPoolExecutor& lhs,
...
inline void
mwcex::swap(BdlmtFixedThreadPoolExecutor& lhs,
            BdlmtFixedThreadPoolExecutor& rhs) BSLS_KEYWORD_NOEXCEPT
{
    lhs.swap(rhs);
}
