...
// mwctsk_logcontroller.h                                             -*-C++-*-
#ifndef INCLUDED_MWCTSK_LOGCONTROLLER
#define INCLUDED_MWCTSK_LOGCONTROLLER

//@PURPOSE: Provide a mechanism to interface with the ball log infrastructure.
//
//@CLASSES:
//  mwctsk::LogController:       mechanism to interface with the ball system
//  mwctsk::LogControllerConfig: VST for the configuration of a 'LogController'
//
//@DESCRIPTION: 'mwctsk::LogController' is a mechanism to initialize and
// manipulate the ball log infrastructure.  'mwctsk::LogControllerConfig' is a
// value-semantic type object used to provide configuration parameters to an
// 'mwctsk::LogController'.  'LogController' uses a 'ball::AsyncFileObserver'
// to asynchronously write logs to a file, and 'mwctsk::ConsoleObserver' to
...
/// Logs cleanup
///------------
// LogController will use an 'mwctsk::LogCleaner' to periodically delete old
...
// the log filename.
//..
//  mwctsk::LogControllerConfig config(allocator);
//
...
//
//  mwctsk::LogController logController(allocator);
