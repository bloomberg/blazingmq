...
// mwcc_multiqueuethreadpool.t.cpp                                    -*-C++-*-
...
typedef mwcc::MultiQueueThreadPool<int> MQTP;
...
// ------------------------------------------------------------------------
{
    ...
    // 'mwcc::MultiQueueThreadPoolUtil::defaultCreator<int>()').
    ...
    MQTP::Config config(
        ...
        bdlf::BindUtil::bindS(s_allocator_p,
                              ...
                              &queueContextMap),
        mwcc::MultiQueueThreadPoolUtil::defaultCreator<int>(),
        mwcc::MultiQueueThreadPoolUtil::noOpResetter<int>(),
        s_allocator_p);
...
// ------------------------------------------------------------------------
{
    ...
    mwctst::TestHelper::printTestName("PERFORMANCE TEST");
...
// ------------------------------------------------------------------------
{
    ...
    mwctst::TestHelper::printTestName("FIXED PERFORMANCE TEST");
