...
// mwcc_monitoredqueue_bdlccsingleconsumerqueue.t.cpp                 -*-C++-*-
...
// ------------------------------------------------------------------------
{
    mwctst::TestHelper::printTestName("MONITORED SINGLECONSUMER QUEUE "
                                      "- BREATHING TEST");
...

    {
        ...
        mwcc::MonitoredQueue<bdlcc::SingleConsumerQueue<int> > queue(
            k_QUEUE_SIZE,
            s_allocator_p);
...
// ------------------------------------------------------------------------
{
    ...
    mwctst::TestHelper::printTestName("MONITORED SINGLE CONSUMER QUEUE "
                                      "- PERFORMANCE TEST");
