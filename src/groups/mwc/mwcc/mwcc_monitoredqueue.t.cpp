...
// ------------------------------------------------------------------------
{
    mwctst::TestHelper::printTestName("MONITORED  QUEUE STATE "
                                      "- TO ASCII");
    ...
    for (size_t idx = 0; idx < k_NUM_DATA; ++idx) {
        ...
        ascii = mwcc::MonitoredQueueState::toAscii(
            mwcc::MonitoredQueueState::Enum(test.d_value));
...
// ------------------------------------------------------------------------
{
    mwctst::TestHelper::printTestName("MONITORED QUEUE STATE - PRINT");
    ...
    for (size_t idx = 0; idx < k_NUM_DATA; ++idx) {
        ...
        mwcc::MonitoredQueueState::Enum obj(
            static_cast<mwcc::MonitoredQueueState::Enum>(test.d_value));

        // print
        mwcc::MonitoredQueueState::print(out, obj, 0, 0);
        ...
        mwcc::MonitoredQueueState::print(out, obj, 0, -1);
