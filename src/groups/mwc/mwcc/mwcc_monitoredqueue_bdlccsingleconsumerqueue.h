...
// mwcc_monitoredqueue_bdlccsingleconsumerqueue.h                     -*-C++-*-
#ifndef INCLUDED_MWCC_MONITOREDQUEUE_BDLCCSINGLECONSUMERQUEUE
#define INCLUDED_MWCC_MONITOREDQUEUE_BDLCCSINGLECONSUMERQUEUE
...
//
//@SEE_ALSO: mwcc_monitoredqueue, bdlcc_singleconsumerqueue
//
//@DESCRIPTION: This component defines a partial specialization of
// 'mwcc::MonitoredQueueTraits' that interfaces
// 'mwcc::MonitoredSingleConsumerQueue' with 'bdlcc::SingleConsumerQueue'
...
/// interface a `mwcc::MonitoredQueue` with a `bdlcc::SingleConsumerQueue`.
