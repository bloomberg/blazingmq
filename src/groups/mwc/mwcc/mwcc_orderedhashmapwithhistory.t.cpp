...
// mwcc_orderedhashmapwithhistory.t.cpp                               -*-C++-*-
...
typedef mwcc::OrderedHashMapWithHistory<size_t, size_t> ObjectUnderTest;
...
static void test1_insert()
{
    ...
    // -
    mwctst::TestHelper::printTestName("HISTORY");
...
static void test2_eraseMiddleToEnd()
{
    ...
    // ------------------------------------------------------------------------
    mwctst::TestHelper::printTestName("ERASE_MIDDLE_TO_END");
...
static void test3_eraseMiddleToBegin()
{
    ...
    mwctst::TestHelper::printTestName("ERASE_MIDDLE_TO_BEGIN");
...
static void test4_gc()
{
    ...
    mwctst::TestHelper::printTestName("ERASE_AND_GC");
...
static void test5_insertAfterEnd()
{
    ...
    mwctst::TestHelper::printTestName("INSERT_AFTER_END");
