...
// mwcc_orderedhashmapwithhistory.h                                   -*-C++-*-
#ifndef INCLUDED_MWCC_ORDEREDHASHMAPWITHHISTORY
#define INCLUDED_MWCC_ORDEREDHASHMAPWITHHISTORY

//@PURPOSE: Provide a hash set with predictive iteration order and a history of
//          erased items.
//
//@CLASSES:
//  mwcc::OrderedHashMapWithHistory : Hash table with predictive iteration
//                                    order and history.
//
//@SEE_ALSO: mwcc::OrderedHashMap
//
//@DESCRIPTION: 'mwcc::OrderedHashMapWithHistory' is a wrapper around
// 'mwcc::OrderedHashMap' which adds insertion time in nanoseconds as part of
...
/// For use only by `mwcc::OrderedHashMapWithHistory` implementation.
