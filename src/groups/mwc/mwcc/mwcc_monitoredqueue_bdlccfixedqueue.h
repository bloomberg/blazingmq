...
// mwcc_monitoredqueue_bdlccfixedqueue.h                              -*-C++-*-
#ifndef INCLUDED_MWCC_MONITOREDQUEUE_BDLCCFIXEDQUEUE
#define INCLUDED_MWCC_MONITOREDQUEUE_BDLCCFIXEDQUEUE
...
//
//@SEE_ALSO: mwcc_monitoredqueue, bdlcc_fixedqueue
//
//@DESCRIPTION: This component defines a partial specialization of
// 'mwcc::MonitoredQueueTraits' that interfaces 'mwcc::MonitoredFixedQueue'
...
/// interface a `mwcc::MonitoredQueue` with a `bdlcc::FixedQueue`.
