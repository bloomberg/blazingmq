...
// bmqma_countingallocatorstore.cpp                                   -*-C++-*-
...
{
    if (!dynamic_cast<bmqma::CountingAllocator*>(d_allocator_p)) {
    ...
    bmqma::CountingAllocator* newAlloc = new (*d_allocator_p)
        bmqma::CountingAllocator(name, d_allocator_p);
