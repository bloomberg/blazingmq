...
// bmqio_statchannelfactory.h                                         -*-C++-*-
#ifndef INCLUDED_BMQIO_STATCHANNELFACTORY
#define INCLUDED_BMQIO_STATCHANNELFACTORY
...
// bmqio::StatChannelFactoryHandle
// bmqio::StatChannelFactoryUtil
//
//@SEE_ALSO:
//
//@DESCRIPTION: This component defines a mechanism,
// 'bmqio::StatChannelFactory', which is a decorator of a base
// 'bmqio::ChannelFactory' that gives it the ability to create channels that
...
class StatChannelFactoryConfig {
  public:
    ...
    /// specified `handle`.
    typedef bsl::function<bslma::ManagedPtr<bmqst::StatContext>(
...
struct StatChannelFactoryUtil {
  ...
  public:
    ...
    /// by the factory.
    static bmqst::StatContextConfiguration
    ...
    static void
    initializeStatsTable(bmqst::Table*                  table,
