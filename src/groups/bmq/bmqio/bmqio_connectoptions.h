...
// bmqio_connectoptions.h                                             -*-C++-*-
#ifndef INCLUDED_BMQIO_CONNECTOPTIONS
#define INCLUDED_BMQIO_CONNECTOPTIONS

//@PURPOSE: Provide a type encapsulating options for 'ChannelFactory::connect'.
//
//@CLASSES:
//  bmqio::ConnectOptions: type encapsulating 'ChannelFactory::connect' options
//
//@DESCRIPTION: This component defines a value-semantic type,
// 'bmqio::ConnectOptions', which encapsulates various connection options
// passed to 'bmqio::ChannelFactory::connect'.
...
inline bsl::ostream& bmqio::operator<<(bsl::ostream&                stream,
                                       const bmqio::ConnectOptions& obj)
{
