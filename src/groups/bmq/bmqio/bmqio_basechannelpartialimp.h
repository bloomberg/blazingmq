...
// bmqio_basechannelpartialimp.h                                      -*-C++-*-
#ifndef INCLUDED_BMQIO_BASECHANNELPARTIALIMP
#define INCLUDED_BMQIO_BASECHANNELPARTIALIMP

//@PURPOSE: Provide a partial 'Channel' imp for a 'base' channel
//
//@CLASSES:
// bmqio::BaseChannelPartialImp
//
//@SEE_ALSO:
//
//@DESCRIPTION: This component defines a partial implementation of the
// 'bmqio::Channel' protocol for a 'base' Channel', that is a channel that is
...
inline bmqvt::PropertyBag& BaseChannelPartialImp::properties()
{
    return d_properties;
}
...
inline const bmqvt::PropertyBag& BaseChannelPartialImp::properties() const
{
    return d_properties;
}
