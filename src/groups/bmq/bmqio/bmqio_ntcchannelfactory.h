...
// bmqio_ntcchannelfactory.h                                          -*-C++-*-
#ifndef INCLUDED_BMQIO_NTCCHANNELFACTORY
#define INCLUDED_BMQIO_NTCCHANNELFACTORY

//@PURPOSE: Provide a 'bmqio::NtcChannel' factory.
//
//@CLASSES:
//  bmqio::NtcChannelFactory: Factory for bmqio::NtcChannel' objects
//
//@SEE_ALSO:
//  bmqio_channelfactory
//
//@DESCRIPTION: This component defines a mechanism, 'bmqio::NtcChannelFactory',
...
class NtcChannelFactory : public bmqio::ChannelFactory {
  public:
    ...
    typedef void CreateFnType(
        ...
        const bsl::shared_ptr<bmqio::ChannelFactoryOperationHandle>& handle);
  ...
  private:
    ...
    typedef bsl::shared_ptr<bmqio::NtcListener> ListenerEntry;
    ...
    typedef bsl::shared_ptr<bmqio::NtcChannel> ChannelEntry;
...
{
    typedef bsl::vector<bsl::shared_ptr<bmqio::NtcChannel> > ChannelVector;
