...
//@PURPOSE: Value-semantic type representing endpoints for 'bmqio' channels
//
//@CLASSES:
//  bmqio::TCPEndpoint
//
...
// 'bmqio::TCPEndpoint', to convert between a URI ('tcp://host:port')
// representation and a { host, port } pair, to use with the 'bmqio' channels.
...
inline bsl::ostream& bmqio::operator<<(bsl::ostream&             stream,
                                       const bmqio::TCPEndpoint& endpoint)
{
