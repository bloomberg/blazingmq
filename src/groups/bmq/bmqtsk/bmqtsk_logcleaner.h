...
// bmqtsk_logcleaner.h                                                -*-C++-*-
#ifndef INCLUDED_BMQTSK_LOGCLEANER
#define INCLUDED_BMQTSK_LOGCLEANER

//@PURPOSE: Provide a mechanism to periodically clean up old logs.
//
//@CLASSES:
//  bmqtsk::LogCleaner: Mechanism to periodically clean up old logs
//
//@DESCRIPTION: 'bmqtsk::LogCleaner' is a mechanism to manage periodic
...
//..
//  bmqtsk::LogCleaner logCleaner(&scheduler);
//..
//
...
class LogCleaner {
  private:
    ...
    // separate thread.
    bmqex::Strand<bmqex::SystemExecutor> d_logsCleaningContext;
