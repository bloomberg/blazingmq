...
//
//@CLASSES:
//  bmqtsk::ConsoleObserver: BALL observer printing to stdout
//
//@DESCRIPTION: 'bmqtsk::ConsoleObserver' is a concrete implementation of the
...
//..
//  consoleObserver.setCategoryColor("MQB*", "green")
//                 .setCategoryColor("BMQTSK.APPLICATION", "red-on-yellow");
//..
//
...
class ConsoleObserver : public ball::ObserverAdapter {
  private:
    ...
    BALL_LOG_SET_CLASS_CATEGORY("BMQTSK.CONSOLEOBSERVER");
