...
// bmqtsk_syslogobserver.h                                            -*-C++-*-
#ifndef INCLUDED_BMQTSK_SYSLOGOBSERVER
#define INCLUDED_BMQTSK_SYSLOGOBSERVER

//@PURPOSE: Provide a system log output for BALL logging.
//
//@CLASSES:
//  bmqtsk::SyslogObserver: BALL observer printing to a system log
//
//@DESCRIPTION: 'bmqtsk::SyslogObserver' is a concrete implementation of the
