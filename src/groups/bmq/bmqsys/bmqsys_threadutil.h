...
// bmqsys_threadutil.h                                                -*-C++-*-
#ifndef INCLUDED_BMQSYS_THREADUTIL
#define INCLUDED_BMQSYS_THREADUTIL

//@PURPOSE: Provide utilities related to thread management.
//
//@CLASSES:
//  bmqsys::ThreadUtil: utilities related to thread management.
//
//@DESCRIPTION: 'bmqsys::ThreadUtil' provide a utility namespace for operations
