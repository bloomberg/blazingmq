...
// bmqstm_values.h              *DO NOT EDIT*              @generated -*-C++-*-
#ifndef INCLUDED_BMQSTM_VALUES
#define INCLUDED_BMQSTM_VALUES
...
BDLAT_DECL_ENUMERATION_TRAITS(bmqstm::StatContextConfigurationFlags)
...
BDLAT_DECL_ENUMERATION_TRAITS(bmqstm::StatContextUpdateFlags)
...
BDLAT_DECL_ENUMERATION_TRAITS(bmqstm::StatValueFields)
...
BDLAT_DECL_ENUMERATION_TRAITS(bmqstm::StatValueType)
...
BDLAT_DECL_SEQUENCE_WITH_ALLOCATOR_BITWISEMOVEABLE_TRAITS(
    bmqstm::StatContextConfiguration)
...
// --noIdent --package bmqstm --msgComponent values bmqstm.xsd
