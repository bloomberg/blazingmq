...
// bmqst_statcontexttableinfoprovider.h                               -*-C++-*-
#ifndef INCLUDED_BMQST_STATCONTEXTTABLEINFOPROVIDER
#define INCLUDED_BMQST_STATCONTEXTTABLEINFOPROVIDER

//@PURPOSE: Provide a 'bmqst::TableInfoProvider' for a table 'StatContext'.
//
//@CLASSES:
...
// 'bmqst::StatContextTableInfoProvider' which is an implementation of
// 'bmqst::TableInfoProvider' using a 'bmqst::StatContext'.  It gives an
// application a way of easily printing a table 'bmqst::StatContext' to a
// stream.
//
// Refer to the documentation of 'bmqst::Table' and 'bmqst::TableUtil' for
// usage examples.
