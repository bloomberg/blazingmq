...
, d_allocator_p(allocator)
{
    bmqu::BlobUtil::positionToOffset(&d_offset, *blob, start);
}
...
// FREE FUNCTIONS
bool bmqst::operator==(const bmqst::BlobDataComparer& lhs,
                       const bmqst::BlobDataComparer& rhs)
{
...
bsl::ostream& bmqst::operator<<(bsl::ostream&                  stream,
                                const bmqst::BlobDataComparer& val)
{
