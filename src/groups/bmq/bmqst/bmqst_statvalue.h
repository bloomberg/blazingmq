...
//
//@CLASSES:
// bmqst::StatValue     : value (or variable) able to collect statistics.
// bmqst::StatValueUtil : non-primitive operations on a 'StatValue'.
//
//@SEE_ALSO:
//  bmqst_statcontext
//  bmqst_statutil
//
//@DESCRIPTION: This component defines a mechanism, 'bmqst::StatValue', which
...
// the 'bmqst::StatContext' component.  Refer to the usage examples in the
...
// FREE OPERATORS
inline bool bmqst::operator==(const StatValue_SnapshotLocation& lhs,
                              const StatValue_SnapshotLocation& rhs)
{
