...
// bmqst_statcontextuserdata.h                                        -*-C++-*-
#ifndef INCLUDED_BMQST_STATCONTEXTUSERDATA
#define INCLUDED_BMQST_STATCONTEXTUSERDATA
...
/// Protocol for `bmqst::StatContext` user data
class StatContextUserData {
  public:
    // CREATORS
