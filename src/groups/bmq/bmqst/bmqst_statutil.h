...
// bmqst_statutil.h                                                   -*-C++-*-
#ifndef INCLUDED_BMQST_STATUTIL
#define INCLUDED_BMQST_STATUTIL

//@PURPOSE: Provide utility functions operating on a 'bmqst::StatValue'.
//
//@DEPRECATED: Use 'bmqst::MetricUtil' instead.
//
//@CLASSES:
// bmqst::StatUtil : container for functions operating on a 'bmqst::StatValue'.
//
//@SEE_ALSO: bmqst_metricutil, bmqst_table
//
//@DESCRIPTION: This component defines a utility, 'bmqst::StatUtil' containing
// functions for calculating statistics of a provided 'bmqst::StatValue'.
//
// Applications should probably not be using these functions directly with a
// given 'bmqst::StatValue' except for specific cases.  Most likely this
// utility will instead be used to create a 'bmqst::Table'.
//
// Refer to the documentation of 'bmqst::Table' for a usage example.
