...
// bmqst_testtableinfoprovider.h -*-C++-*-
#ifndef INCLUDED_BMQST_TESTTABLEINFOPROVIDER
#define INCLUDED_BMQST_TESTTABLEINFOPROVIDER

//@PURPOSE: Provide a test implementation of 'bmqst::TableInfoProvider'
//
//@CLASSES:
// bmqst::TestTableInfoProvider
//
//@SEE_ALSO:
//
//@DESCRIPTION: This component defines a mechanism,
// 'bmqst::TestTableInfoProvider', which is a test implementation of the
// 'bmqst::TableInfoProvider' protocol for use in test drivers.  It allows the
...
/// Test implementation of `bmqst::TableInfoProvider`
