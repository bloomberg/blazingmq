...
// bmqst_stringkey.h -*-C++-*-
#ifndef INCLUDED_BMQST_STRINGKEY
#define INCLUDED_BMQST_STRINGKEY

//@PURPOSE: Provide a smart string key for associative containers.
//
//@CLASSES:
// bmqst::StringKey: a better string key for containers
//
//@DESCRIPTION:
// This class provides a mechanism, 'bmqst::StringKey', which is intended to be
...
// FREE OPERATORS
inline bool bmqst::operator<(const StringKey& lhs, const StringKey& rhs)
{
...
// =========================================
// struct hash<BloombergLP::bmqst::StringKey>
// =========================================

template <>
struct hash<BloombergLP::bmqst::StringKey> {
    // ACCESSORS
    size_t operator()(const BloombergLP::bmqst::StringKey& key) const;
};
...
inline size_t hash<BloombergLP::bmqst::StringKey>::operator()(
    const BloombergLP::bmqst::StringKey& key) const
{
