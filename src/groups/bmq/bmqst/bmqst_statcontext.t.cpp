                          ...
                          const char*      snapshotDesc)
{
    ...
    bsl::vector<bsls::Types::Int64> expectedValues =
        bmqst::TestUtil::int64Vector(snapshotDesc);
...
/// and `false` otherwise.
static bool hasField(const bmqstm::StatContextUpdate& contextUpdate,
                     int                              index,
                     bmqstm::StatValueFields::Value   field)
{
...
static bsls::Types::Int64 field(const bmqstm::StatContextUpdate& contextUpdate,
                                int                              index,
                                bmqstm::StatValueFields::Value   field)
{
                               ...
                               bslma::Allocator* allocator)
{
    ...
    bmqst::StatContext updatedContext(
        bmqst::StatContextConfiguration(update, allocator));
                              ...
                              bslma::Allocator* allocator)
{
    ...
    // StatContext.
    bslma::ManagedPtr<bmqst::StatContext> client1 = context.addSubcontext(
        bmqst::StatContextConfiguration("tcp://1234"));
                                   ...
                                   bslma::Allocator* allocator)
{
    ...
    tip.addColumn("Bytes", e_IN, bmqst::StatUtil::value, 0);
    tip.addColumn("Bytes/s (last min)", e_IN, bmqst::StatUtil::rate, 60, 0);
    tip.addColumn("Bytes/s (5 min)",
                  e_IN,
                  bmqst::StatUtil::rate,
                  bmqst::StatValue::SnapshotLocation(1, 4),
                  bmqst::StatValue::SnapshotLocation(1, 0));

    tip.addColumn("Msg", e_IN, bmqst::StatUtil::increments, 0);
    tip.addColumn("Msg/s (last min)",
                  e_IN,
                  bmqst::StatUtil::incrementRate,
                  60,
                  0);
...
static void testUpdates(bslma::Allocator* /*allocator*/)
{
    ...
    bmqstm::StatContextUpdate u1, u2;
...
static void testUpdatesWithUsageExample(bslma::Allocator* allocator)
{
    ...
    bmqu::MemOutStream nstream;
    bmqu::MemOutStream ustream;
