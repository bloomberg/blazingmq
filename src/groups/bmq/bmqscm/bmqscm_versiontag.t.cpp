...
int main(int argc, char** argv)
{
    ...
    case 1: {
        ...
        BSLIM_TESTUTIL_ASSERT(BMQ_VERSION_MAJOR ==
                              (BMQ_VERSION / 10000) % 100);
        BSLIM_TESTUTIL_ASSERT(BMQ_VERSION_MINOR == (BMQ_VERSION / 100) % 100);
        BSLIM_TESTUTIL_ASSERT(0 == BMQ_VERSION % 100);
        ...
        BSLIM_TESTUTIL_ASSERT(BMQ_EXT_VERSION == 999999);
    } break;
