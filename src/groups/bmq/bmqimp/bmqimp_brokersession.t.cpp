...
struct TestSession BSLS_CPP11_FINAL {
  ...
  public:
    ...
    bool verifyOperationStatus(const bmqt::SessionEventType::Enum eventType,
                               int                                eventStatus);

    /// Return `true` if a session event of the specified `eventType` and
    /// with the specified `eventResult` was generated by the session object
    /// under the test, `false` otherwise.
    ...
    /// under the test, `false` otherwise.
    bool
    verifyOperationResult(const bmqt::SessionEventType::Enum  eventType,
                          bmqp_ctrlmsg::StatusCategory::Value eventResult);
    ...
    bmqt::GenericResult::Enum          eventResult)
{
    ...
    else if (event->result() != eventResult) {
        PV_SAFE("Unexpected event status: " << event->result()
                                            << " "
                                               "Expected: "
                                            << eventResult);
        return false;  // RETURN
    ...
    bmqp_ctrlmsg::StatusCategory::Value eventResult)
{
    return verifyOperationResult(
        eventType,
        static_cast<bmqt::GenericResult::Enum>(eventResult));
}
...
//   ----------------------------------------------------------------------
{
    ...
    obj.verifyOperationStatus(bmqt::SessionEventType::e_QUEUE_CONFIGURE_RESULT,
                              bmqt::ConfigureQueueResult::e_REFUSED);
...
static void queueOpenCloseAsync(bsls::Types::Uint64 queueFlags)
{
    ...
    BMQTST_ASSERT(
        obj.verifyOperationStatus(bmqt::SessionEventType::e_QUEUE_CLOSE_RESULT,
                                  bmqt::CloseQueueResult::e_UNKNOWN_QUEUE));
...
int main(int argc, char* argv[])
{
    ...
    case 67: /* removed test */ break;
    case 66: /* removed test */ break;
