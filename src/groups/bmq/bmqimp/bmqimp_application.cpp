...
// Application::ChannelFactoryPipeline_Int::ChannelFactoryPipeline_Int(
//     bdlbb::BlobBufferFactory*   blobBufferFactory,
//     bdlmt::EventScheduler*      scheduler,
...
// void Application::ChannelFactoryPipeline_Int::listen(
//     bmqio::Status*               status,
...
// void Application::ChannelFactoryPipeline_Int::connect(
//     bmqio::Status*               status,
//     bslma::ManagedPtr<OpHandle>* handle,
...
// int Application::ChannelFactoryPipeline_Int::start()
// {
...
// void Application::ChannelFactoryPipeline_Int::stop()
// {
