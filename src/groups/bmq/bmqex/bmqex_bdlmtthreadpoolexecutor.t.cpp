...
// bmqex_bdlmtthreadpoolexecutor.t.cpp                                -*-C++-*-
#include <bmqex_bdlmtthreadpoolexecutor.h>
...
//
// Plan:
//   Construct an instance of 'bmqex::BdlmtThreadPoolExecutor' and check
//   postconditions.
//
// Testing:
//   bmqex::BdlmtThreadPoolExecutor's constructor
// ------------------------------------------------------------------------
{
...
//
// Testing:
//   bmqex::BdlmtThreadPoolExecutor::post
// ------------------------------------------------------------------------
{
    bslma::TestAllocator alloc;
    bdlmt::ThreadPool    threadPool(bslmt::ThreadAttributes(),
...
//
// Testing:
//   bmqex::BdlmtThreadPoolExecutor::swap
// ------------------------------------------------------------------------
{
    bslma::TestAllocator alloc;
...
//
// Testing:
//   bmqex::BdlmtThreadPoolExecutor::context
// ------------------------------------------------------------------------
{
    bslma::TestAllocator alloc;
    bdlmt::ThreadPool    threadPool1(bslmt::ThreadAttributes(),
...
//
// Testing:
//   bmqex::BdlmtThreadPoolExecutor's equality comparison operator
//   bmqex::BdlmtThreadPoolExecutor's inequality comparison operator
// ------------------------------------------------------------------------
{
    bslma::TestAllocator alloc;
    bdlmt::ThreadPool    threadPool1(bslmt::ThreadAttributes(),
