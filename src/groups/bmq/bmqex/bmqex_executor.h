...
// bmqex_executor.h                                                   -*-C++-*-
#ifndef INCLUDED_BMQEX_EXECUTOR
#define INCLUDED_BMQEX_EXECUTOR

//@PURPOSE: Provides a polymorphic wrapper for executor types.
//
//@CLASSES:
//  bmqex::Executor: a polymorphic wrapper for executor types
//
//@DESCRIPTION:
...
// 'bmqex::Executor' is to an executor object what 'bsl::function' is to a
// function object.
//
...
// but is supplied an executor of type 'bmqex::SystemExecutor'.
//..
//  class Notificator {
...
//    public:
//      // CREATORS
//      Notificator(const bmqex::Executor& executor,
...
//  };
//
//  Notificator::Notificator(const bmqex::Executor& executor,
//                           const Callback&        callback)
//  : d_executor(executor)
//  , d_callback(callback)
//  {
...
//  Notificator notificator(bmqex::SystemExecutor(),
//                          [](){
...
// FREE OPERATORS
inline void bmqex::swap(Executor& lhs, Executor& rhs) BSLS_KEYWORD_NOEXCEPT
{
    lhs.swap(rhs);
}
