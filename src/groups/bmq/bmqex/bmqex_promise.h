...
// bmqex_promise.h                                                    -*-C++-*-
#ifndef INCLUDED_BMQEX_PROMISE
#define INCLUDED_BMQEX_PROMISE

//@PURPOSE: Provides a mechanism to store the result of an async operation.
//
//@CLASSES:
//  bmqex::Promise:       a promise
//  bmqex::PromiseBroken: exception class to indicate a promise was broken
//
//@SEE ALSO:
//  bmqex_future
//
//@DESCRIPTION:
// This component provides a mechanism, 'bmqex::Promise', to store a value (or
// an exception) that can later be retrieved from the corresponding
// 'bmqex::Future' object. 'bmqex::Promise' and 'bmqex::Future' communicate via
// their underlying shared state (see 'bmqex::FutureSharedState').
//
// In addition the generalized 'bmqex::Promise<R>' class template two
// specializations, 'bmqex::Promise<void>', and 'bmqex::Promise<R&>' are
// provided.
//
// This component also provides a class, 'bmqex::PromiseBroken', to indicate a
// promise was broken, that is, an 'bmqex::Promise' object was destroyed before
// its associated shared state has been made ready.
//
/// Thread safety
///-------------
// With the exception of assignment operators, as well as the 'swap' member
// function, 'bmqex::Promise' is fully thread-safe, meaning that multiple
...
// Generated on Wed Nov  5 23:17:39 2025
