...
//
// Plan:
//   Construct an instance of 'bmqex::FutureSharedState'. Check
//   postconditions. Destroy the object.
//
// Testing:
//   'bmqex::FutureSharedState's constructors
//   'bmqex::FutureSharedState's destructor
// ------------------------------------------------------------------------
{
    ...
    // clock constructor
    {
        bmqex::FutureSharedState<int> sharedState(
...
//
// Testing:
//   bmqex::FutureSharedState::setValue
// ------------------------------------------------------------------------
{
    bslma::TestAllocator alloc;
    ...
    {
        // create shared state
        bmqex::FutureSharedState<ThrowOnCopyValue> sharedState(&alloc);
...
//
// Testing:
//   bmqex::FutureSharedState::emplaceValue
// ------------------------------------------------------------------------
{
    bslma::TestAllocator alloc;
    ...
    {
        // create shared state
        bmqex::FutureSharedState<bsl::pair<int, int> > sharedState(&alloc);
...
//
// Testing:
//   bmqex::FutureSharedState::setException
// ------------------------------------------------------------------------
{
...
//
// Testing:
//   bmqex::FutureSharedState::whenReady
// ------------------------------------------------------------------------
{
    bslma::TestAllocator alloc;
...
//
// Testing:
//   bmqex::FutureSharedState::isReady
// ------------------------------------------------------------------------
{
    bslma::TestAllocator alloc;
...
//      - The returned value is 'bmqex::FutureStatus::e_READY'.
//
//   2. Call 'waitFor' on a not ready shared state. Check that the
//      returned value is 'bmqex::FutureStatus::e_TIMEOUT'.
//
// Testing:
//   bmqex::FutureSharedState::waitFor
// ------------------------------------------------------------------------
{
    bslma::TestAllocator alloc;
...
//
// Testing:
//   bmqex::FutureSharedState::waitUntil
// ------------------------------------------------------------------------
{
    bslma::TestAllocator alloc;
...
//
// Testing:
//   'bmqex::Future's constructors
//   'bmqex::Future's destructor
// ------------------------------------------------------------------------
{
    bslma::TestAllocator alloc;
...
// ------------------------------------------------------------------------
{
    ...
    // 1. non-specialized
    {
        ...
        // create futures
        bmqex::Future<int> future1(sharedState1);
        bmqex::Future<int> future2(sharedState2);
    ...
    // 2. void-specialized
    {
        ...
        // create futures
        bmqex::Future<void> future1(sharedState1);
        bmqex::Future<void> future2(sharedState2);
...
//
// Testing:
//   'bmqex::FutureResult's constructors
//   'bmqex::FutureResult's destructor
// ------------------------------------------------------------------------
{
    bslma::TestAllocator alloc;
    ...
    {
        typedef bmqex::Future<int>                  Future;
        typedef bmqex::FutureResult<int>            FutureResult;
        typedef bmqex::Future<int>::SharedStateType SharedState;
    ...
    {
        typedef bmqex::Future<void>                  Future;
        typedef bmqex::FutureResult<void>            FutureResult;
        typedef bmqex::Future<void>::SharedStateType SharedState;
