...
//                             TEST PLAN
//-----------------------------------------------------------------------------
// The component under test: bmqc_twokeyhashmap
//
//-----------------------------------------------------------------------------
// [0]  usage example
// [1]  basic creators
...
// ------------------------------------------------------------------------
{
    ...
    // create a map
    typedef bmqc::TwoKeyHashMap<bsl::string, int, bsl::string> TestMap;
    TestMap                                                    map(&alloc);
...
// ------------------------------------------------------------------------
{
    ...
    // 1. destructor
    {
        bmqc::TwoKeyHashMap<int, int, int> map(&alloc);
    }
...
// ------------------------------------------------------------------------
{
    ...
    {
        typedef bmqc::TwoKeyHashMap<ThrowingInteger, bsl::string, bsl::string>
            Map;
...
// ------------------------------------------------------------------------
{
    ...
    {
        typedef bmqc::TwoKeyHashMap<bsl::string, ThrowingInteger, bsl::string>
            Map;
