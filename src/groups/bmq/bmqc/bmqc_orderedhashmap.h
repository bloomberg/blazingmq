...
// bmqc_orderedhashmap.h                                              -*-C++-*-
#ifndef INCLUDED_BMQC_ORDEREDHASHMAP
#define INCLUDED_BMQC_ORDEREDHASHMAP

//@PURPOSE: Provide a hash table with predictive iteration order.
//
//@CLASSES:
//  bmqc::OrderedHashMap : Hash table with predictive iteration order.
//
//@SEE_ALSO: bsl::unordered_map
//
//@DESCRIPTION: 'bmqc::OrderedHashMap' provides an associative container with
