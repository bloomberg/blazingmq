...
//
//@SEE_ALSO: bmqc_monitoredqueue, bdlcc_singleproducerqueue
//
//@DESCRIPTION: This component defines a partial specialization of
// 'bmqc::MonitoredQueueTraits' that interfaces
// 'bmqc::MonitoredSingleProducerQueue' with 'bdlcc::SingleProducerQueue'
...
/// interface a `bmqc::MonitoredQueue` with a `bdlcc::SingleProducerQueue`.
