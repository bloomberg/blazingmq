...
// bmqc_twokeyhashmap.h                                               -*-C++-*-
#ifndef INCLUDED_BMQC_TWOKEYHASHMAP
#define INCLUDED_BMQC_TWOKEYHASHMAP

//@PURPOSE: Provide a simple hash map container with two keys.
//
//@CLASSES:
// bmqc::TwoKeyHashMap:      hash map container with two keys
// bmqc::TwoKeyHashMapValue: element of the 'TwoKeyHashMap' container
//
//@DESCRIPTION:
// This component provides a mechanism, 'bmqc::TwoKeyHashMap', which is an
...
//..
//  typedef bmqc::TwoKeyHashMap<bsl::string,
//                              int,
//                              bsl::string> TestMap;
...
template <class K1, class K2, class VALUE, class H1, class H2>
inline void
bmqc::swap(TwoKeyHashMap<K1, K2, VALUE, H1, H2>& lhs,
           TwoKeyHashMap<K1, K2, VALUE, H1, H2>& rhs) BSLS_KEYWORD_NOEXCEPT
{
    lhs.swap(rhs);
}
...
template <class K1, class K2, class VALUE, class H1, class H2>
inline bool bmqc::operator==(const TwoKeyHashMap<K1, K2, VALUE, H1, H2>& lhs,
                             const TwoKeyHashMap<K1, K2, VALUE, H1, H2>& rhs)
{
...
template <class MAP>
inline bool bmqc::operator==(const TwoKeyHashMapValue<MAP>& lhs,
                             const TwoKeyHashMapValue<MAP>& rhs)
{
    return lhs.key1() == rhs.key1() && lhs.key2() == rhs.key2() &&
           lhs.value() == rhs.value();
