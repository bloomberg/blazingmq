...
// ------------------------------------------------------------------------
{
    ...
    {
        bmqa::StopStatus obj(bmqtst::TestHelperUtil::allocator());
    ...
    PV("Copy Constructor");
    {
        ...
        bmqa::StopStatus obj1(result,
                              errorDescription,
                              bmqtst::TestHelperUtil::allocator());
        bmqa::StopStatus obj2(obj1, bmqtst::TestHelperUtil::allocator());
    ...
    PV("Assignment Operator");
    {
        ...
        bmqa::StopStatus obj1(result,
                              errorDescription,
                              bmqtst::TestHelperUtil::allocator());
        bmqa::StopStatus obj2(bmqtst::TestHelperUtil::allocator());
        obj2 = obj1;
...
//
// Concerns:
//   Exercise 'bmqa::StopStatus' comparison operators
//
// Testing:
//   bool operator==(const bmqa::StopStatus& lhs,
...
// ------------------------------------------------------------------------
{
    ...
    PV("Inequality");
    {
        ...
        bmqa::StopStatus obj1(bmqt::GenericResult::e_SUCCESS,
                              errorDescription,
                              bmqtst::TestHelperUtil::allocator());
        bmqa::StopStatus obj2(bmqt::GenericResult::e_TIMEOUT,
                              errorDescription,
                              bmqtst::TestHelperUtil::allocator());
...
//
// Concerns:
//   Proper behavior of printing 'bmqa::StopStatus'.
//
// Testing:
//   StopStatus::print()
//   bmqa::operator<<(bsl::ostream& stream, const bmqa::StopStatus& rhs);
// ------------------------------------------------------------------------
{
    bmqtst::TestHelperUtil::ignoreCheckDefAlloc() = true;
    // Can't check the default allocator: 'bmqa::StopStatus::print' and
