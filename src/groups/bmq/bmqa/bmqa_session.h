...
class Session : public AbstractSession {
  ...
  public:
    ...
    ///
    /// DEPRECATED: Use the 'loadMessageEventBuilder instead.  This method will
    //              be marked as `BSLA_DEPRECATED` in future release of libbmq.
    ...
    /// DEPRECATED: Use the `openQueueSync(QueueId *queueId...)` instead.  This
    ///             method will be marked as `BSLA_DEPRECATED` in future
    ///             release of libbmq.
    ...
    ///             method will be marked as `BSLS_DEPRECATED` in future
    ///             release of libbmq.
    virtual int
    ...
    /// DEPRECATED: Use the `openQueueAsync(...)` with callback flavor instead.
    ...
    /// DEPRECATED: Use the 'closeQueueSync(QueueId *queueId...) instead.  This
    ///             method will be marked as `BSLA_DEPRECATED` in future
    ///             release of libbmq.
