...
//
// Plan:
//   Create a 'bmqu::OperationChain' object and check postconditions.
// ------------------------------------------------------------------------
{
    // PRECONDITIONS
    BSLS_ASSERT(threadPool);
...
// ------------------------------------------------------------------------
{
    ...
    // 2. append non-empty link list containing empty links
    {
        ...
        bmqu::OperationChainLink link2(chain.allocator());
