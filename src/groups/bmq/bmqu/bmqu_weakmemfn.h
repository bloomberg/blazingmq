...
// bmqu_weakmemfn.h                                                   -*-C++-*-
#ifndef INCLUDED_BMQU_WEAKMEMFN
#define INCLUDED_BMQU_WEAKMEMFN

//@PURPOSE: Provides a wrapper type for invoking member functions on a weak_ptr
//
//@CLASSES:
//  bmqu::WeakMemFn:         mem. fn. wrapper
//  bmqu::WeakMemFnInstance: mem. fn. wrapper with embedded instance pointer
//  bmqu::WeakMemFnResult:   result of a mem. fn. wrapper invocation
//  bmqu::WeakMemFnUtil:     utility for constructing wrapper objects
//
//@DESCRIPTION:
...
//
// The first wrapper, 'bmqu::WeakMemFn', contains a member function pointer and
...
//
// The second wrapper, 'bmqu::WeakMemFnInstance', contains both the member
...
// the exact same behavior as described for 'bmqu::WeakMemFn'.
//
// The result of a 'bmqu::WeakMemFn' or 'bmqu::WeakMemFnInstance' wrapper
// invocation is represented by an instance of 'bmqu::WeakMemFnResult'.  This
...
// has expired or not.
//
// Finally, the 'bmqu::WeakMemFnUtil' utility class provides utility functions
// for constructing 'bmqu::WeakMemFn' and 'bmqu::WeakMemFnInstance' objects.
//
///'bmqu::WeakMemFn<PROT>' call operator
///-------------------------------------
// 'bmqu::WeakMemFn' provides a call operator that, in C++11, would be defined
...
//      // an instance of 'bmqu::WeakMemFnResult', where 'd_memFn' is the
//      // stored member function pointer. Otherwise, return a null
//      // 'bmqu::WeakMemFnResult' object.
//..
...
// to 9.
//
///'bmqu::WeakMemFnInstance<PROT>' call operator
///---------------------------------------------
// 'bmqu::WeakMemFnInstance' provides a call operator that, in C++11, would be
...
//      // wrapped in an instance of 'bmqu::WeakMemFnResult', where 'd_memFn'
...
// TBD:
//-----
//: o Provide a move c-tor for 'bmqu::WeakMemFnResult' that does not take an
...
/// Provides a call operator for the derived class `bmqu::WeakMemFn`, such
...
/// `bmqu::WeakMemFnInstance`, such that its call signature is compatible
...
/// `bmqu::WeakMemFn` or `bmqu::WeakMemFnInstance`, that is semantically
