...
// bmqu_atomicvalidator.h                                             -*-C++-*-
#ifndef INCLUDED_BMQU_ATOMICVALIDATOR
#define INCLUDED_BMQU_ATOMICVALIDATOR

//@PURPOSE: Provide a mechanism to acquire/release and invalidate a resource.
//
//@CLASSES:
//  bmqu::AtomicValidator:      acquire/release/invalidate a resource
//  bmqu::AtomicValidatorSp:    shared pointer to an 'bmqu::AtomicValidator'
//  bmqu::AtomicValidatorGuard: guard for on a 'bmqu::AtomicValidator' object
//
//@DESCRIPTION: The mechanisms provided by this component allows to manage the
// lifecycle of a resource thanks to the 'bmqu::AtomicValidator' object, which
// can be acquired with the associated 'bmqu::AtomicValidatorGuard'.  For usage
// convenience, a 'bmqu::AtomicValidatorSp' typedef is provided.  The resource
...
//..
//  class MyResource {
//      typedef bsl::shared_ptr<bmqu::AtomicValidator> AtomicValidatorSp;
...
// create a 'bmqu::AtomicValidatorGuard' on the validator, and check whether
