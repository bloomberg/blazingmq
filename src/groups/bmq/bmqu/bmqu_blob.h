...
// bmqu_blob.h                                                    -*-C++-*-
#ifndef INCLUDED_BMQU_BLOB
#define INCLUDED_BMQU_BLOB

//@PURPOSE: Provide utility functions for working with Blobs.
//
//@CLASSES:
//  bmqu::BlobPosition       : POD defining a position in a blob.
//  bmqu::BlobSection        : POD defining a range of bytes in a blob.
//  bmqu::BlobUtil           : Static blob manipulation functions.
//  bmqu::BlobStartHexDumper : Pretty printer for blobs.
//
//@DESCRIPTION: This component provides a utility, 'bmqu::BlobUtil', which
...
// FREE OPERATORS
inline bsl::ostream& bmqu::operator<<(bsl::ostream&             stream,
                                      const bmqu::BlobPosition& object)
{
    return object.print(stream, 0, -1);
}

inline bsl::ostream& bmqu::operator<<(bsl::ostream&            stream,
                                      const bmqu::BlobSection& object)
{
    return object.print(stream, 0, -1);
}
