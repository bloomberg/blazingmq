...
// bmqu_tempdirectory.h                                               -*-C++-*-
#ifndef INCLUDED_BMQU_TEMPDIRECTORY
#define INCLUDED_BMQU_TEMPDIRECTORY

//@PURPOSE: Provide a guard for creating a temporary directory.
//
//@CLASSES:
//  bmqu::TempDirectory: Guard for a temporary directory
//
//@SEE_ALSO: bmqu_temputil
//
//@DESCRIPTION: This component provides a guard, 'bmqu::TempDirectory', that
...
// directory is automatically removed when the 'bmqu::TempDirectory' object is
// destroyed.  For the definition of the effective temporary directory for the
// current process, see the bmqu_temputil component documentation.
//
/// Thread Safety
///-------------
...
// automatically deleted by a 'bmqu::TempDirectory' guard.
//..
//     bsl::string dirPath;
//     {
//         bmqu::TempDirectory tempDirectory;
