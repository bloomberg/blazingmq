...
static void test1_breathingTest()
{
    ...
    /// @bbref{bdlsb::MemOutStreamBuf} works.  So it is possible that changes
    /// in @bbref{bdlsb::MemOutStreamBuf} will break this test driver.
    /// Said changes will need to be reviewed at that time to determine if
    /// they are acceptable (and this test driver needs fixing) or BDE will
    /// need to make a new component with the changes and keep
