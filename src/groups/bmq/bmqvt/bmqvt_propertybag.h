...
//
//@CLASSES:
// bmqvt::PropertyBag:      bag of named properties
// bmqvt::PropertyBagValue: variant type representing a property
//
//@DESCRIPTION: This component defines a mechanism, 'bmqvt::PropertyBag', for a
// collection of named properties of type 'bmqvt::PropertyBagValue'.  The
...
//..
//  bmqvt::PropertyBag bag(allocator);
...
// FREE OPERATORS
inline bsl::ostream& bmqvt::operator<<(bsl::ostream&                  stream,
                                       const bmqvt::PropertyBagValue& value)
{
    return value.print(stream, 0, -1);
}

inline bsl::ostream& bmqvt::operator<<(bsl::ostream&             stream,
                                       const bmqvt::PropertyBag& value)
{
    return value.print(stream, 0, -1);
}
