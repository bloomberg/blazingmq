...
// ------------------------------------------------------------------------
{
    ...
    BMQTST_ASSERT_EQ(true, obj1.isUnset());

    bmqt::MessageGUID obj2;
    obj1 = obj2;

    BMQTST_ASSERT_EQ(true, obj1.isUnset());
    BMQTST_ASSERT_EQ(true, obj2.isUnset());

    bmqt::MessageGUID obj3(obj1);
    BMQTST_ASSERT_EQ(true, obj3.isUnset());
    ...
    BMQTST_ASSERT_EQ(true,
                     bmqt::MessageGUID::isValidHexRepresentation(hexObj7));
...
static void test2_streamout()
{
...

    {
        ...
        BMQTST_ASSERT_EQ("** UNSET **", osstr.str());
    }

    {
        ...
        BMQTST_ASSERT_EQ(true,
                         bmqt::MessageGUID::isValidHexRepresentation(k_HEX_G));
...

    {
        ...
        BMQTST_ASSERT_EQ(k_EXPECTED, osstr.str());
...
// ------------------------------------------------------------------------
{
    ...
    BMQTST_ASSERT_EQ(k_EXPECTED_ALIGNMENT, k_REAL_ALIGNMENT);
}
...
// ------------------------------------------------------------------------
{
    ...
    BMQTST_ASSERT_EQ(true,
                     bmqt::MessageGUID::isValidHexRepresentation(hexObj));

    bmqt::MessageGUID obj;
    obj.fromHex(hexObj);
    BMQTST_ASSERT_EQ(false, obj.isUnset());
