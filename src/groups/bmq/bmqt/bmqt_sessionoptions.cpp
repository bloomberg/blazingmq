...
, d_disconnectTimeout(k_DISCONNECT_DEFAULT_TIMEOUT_SEC)
...
, d_eventQueueLowWatermark(k_EVENT_QUEUE_LOW_WATERMARK_DEFAULT)
, d_eventQueueHighWatermark(k_EVENT_QUEUE_HIGH_WATERMARK_DEFAULT)
