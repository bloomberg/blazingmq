...
//  bmqtst::ScopedLogObserverUtil: utilities to check log records
//
//@DESCRIPTION: This component defines a mechanism,
// 'bmqtst::ScopedLogObserver', providing an RAII-like implementation of the
...
// 'bmqtst::ScopedLogObserverUtil', to simplify checking that log records
