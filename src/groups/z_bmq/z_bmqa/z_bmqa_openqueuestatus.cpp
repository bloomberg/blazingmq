...
int z_bmqa_OpenQueueStatus__delete(z_bmqa_OpenQueueStatus** status_obj) {
    ...
    bmqa::OpenQueueStatus* status_p = reinterpret_cast<bmqa::OpenQueueStatus*>(*status_obj);
    delete status_p;
    *status_obj = NULL;
...
int z_bmqa_OpenQueueStatus__createCopy(z_bmqa_OpenQueueStatus** status_obj, const z_bmqa_OpenQueueStatus* other) {
    ...
    const bmqa::OpenQueueStatus* other_p = reinterpret_cast<const bmqa::OpenQueueStatus*>(other);
...
int z_bmqa_OpenQueueStatus__createFull(z_bmqa_OpenQueueStatus** status_obj,
    ...
    bmqa::OpenQueueStatus* status_p = new bmqa::OpenQueueStatus(*queueId_p, result_enum, errorDescription_str);
    *status_obj = reinterpret_cast<z_bmqa_OpenQueueStatus*>(status_p);
...
bool z_bmqa_OpenQueueStatus__toBool(const z_bmqa_OpenQueueStatus* status_obj) {
    using namespace BloombergLP;
    const bmqa::OpenQueueStatus* status_p = reinterpret_cast<const bmqa::OpenQueueStatus*>(status_obj);
    return *status_p;
}
