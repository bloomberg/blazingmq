    ...
    z_bmqt_CorrelationId const** correlationId_obj)
{
    ...
    const bmqa::SessionEvent* event_p = reinterpret_cast<const bmqa::SessionEvent*>(event_obj);
    const bmqt::CorrelationId* correlationId_p = reinterpret_cast<const bmqt::CorrelationId*>(&(event_p->correlationId()));
    *correlationId_obj = reinterpret_cast<const z_bmqt_CorrelationId*>(correlationId_p);
