...
class TestListMessages:
    def test_list_messages_fanout(self, cluster: Cluster):
        ...
        for i, uri in enumerate(
            [tc.URI_FANOUT_FOO, tc.URI_FANOUT_BAR, tc.URI_FANOUT_BAZ]
        ):
    ...
    def test_list_messages_priority(self, cluster: Cluster):
        leader = cluster.last_known_leader
        proxies = cluster.proxy_cycle()
