...
def test_queue_stats(single_node: Cluster, domain_urls: tc.DomainUrls) -> None:
    ...
    expect_same_structure(queue_stats, dt.TEST_QUEUE_STATS_AFTER_PURGE_SINGLE_NODE, "after-purge")
...
def test_app_id_stats(multi_node: Cluster, domain_urls: tc.DomainUrls) -> None:
    ...
    expect_same_structure(queue_stats, dt.TEST_QUEUE_STATS_AFTER_PURGE_MULTI_NODE, "after-purge")
