...
const bsls::Types::Int64 CommandLineParameters::DEFAULT_INITIALIZER_TIMESTAMP_GT = 0;

const bsls::Types::Int64 CommandLineParameters::DEFAULT_INITIALIZER_TIMESTAMP_LT = 0;
