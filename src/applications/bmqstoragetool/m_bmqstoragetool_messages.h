...
BDLAT_DECL_SEQUENCE_WITH_ALLOCATOR_BITWISEMOVEABLE_TRAITS(
    m_bmqstoragetool::CommandLineParameters)
...
int CommandLineParameters::manipulateAttributes(t_MANIPULATOR& manipulator)
{
    ...
    ret = manipulator(&d_timestampGt,
                      ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_TIMESTAMP_GT]);
    if (ret) {
        return ret;
    }

    ret = manipulator(&d_timestampLt,
                      ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_TIMESTAMP_LT]);
    if (ret) {
        return ret;
    }

    ret = manipulator(&d_details,
                      ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_DETAILS]);
    if (ret) {
        return ret;
    }

    ret = manipulator(&d_dumpPayload,
                      ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_DUMP_PAYLOAD]);
    if (ret) {
        return ret;
    }

    ret = manipulator(&d_dumpLimit,
                      ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_DUMP_LIMIT]);
    if (ret) {
        return ret;
    }
                                               ...
                                               int            id)
{
    ...
    case ATTRIBUTE_ID_TIMESTAMP_GT: {
        return manipulator(&d_timestampGt,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_TIMESTAMP_GT]);
    }
    case ATTRIBUTE_ID_TIMESTAMP_LT: {
        return manipulator(&d_timestampLt,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_TIMESTAMP_LT]);
    }
    case ATTRIBUTE_ID_DETAILS: {
        return manipulator(&d_details,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_DETAILS]);
    }
    case ATTRIBUTE_ID_DUMP_PAYLOAD: {
        return manipulator(&d_dumpPayload,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_DUMP_PAYLOAD]);
    }
    case ATTRIBUTE_ID_DUMP_LIMIT: {
        return manipulator(&d_dumpLimit,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_DUMP_LIMIT]);
    }
...
inline bsl::string& CommandLineParameters::path()
{
    return d_path;
}

inline bsl::string& CommandLineParameters::journalFile()
{
    return d_journalFile;
}

inline bsl::string& CommandLineParameters::dataFile()
{
    return d_dataFile;
}

inline bsl::string& CommandLineParameters::qlistFile()
{
    return d_qlistFile;
}

inline bsl::vector<bsl::string>& CommandLineParameters::guid()
{
    return d_guid;
}

inline bsl::vector<bsl::string>& CommandLineParameters::queue()
{
    return d_queue;
}

inline bsls::Types::Int64& CommandLineParameters::timestampGt()
{
    return d_timestampGt;
}

inline bsls::Types::Int64& CommandLineParameters::timestampLt()
{
    return d_timestampLt;
}

inline bool& CommandLineParameters::details()
{
    return d_details;
}

inline bool& CommandLineParameters::dumpPayload()
{
    return d_dumpPayload;
}

inline int& CommandLineParameters::dumpLimit()
{
    return d_dumpLimit;
}

inline bool& CommandLineParameters::summary()
{
    return d_summary;
}
...
int CommandLineParameters::accessAttributes(t_ACCESSOR& accessor) const
{
    ...
    ret = accessor(d_timestampGt,
                   ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_TIMESTAMP_GT]);
    if (ret) {
        return ret;
    }

    ret = accessor(d_timestampLt,
                   ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_TIMESTAMP_LT]);
    if (ret) {
        return ret;
    }
    ...
    ret = accessor(d_dumpPayload,
                   ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_DUMP_PAYLOAD]);
    if (ret) {
        return ret;
    }

    ret = accessor(d_dumpLimit,
                   ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_DUMP_LIMIT]);
    if (ret) {
        return ret;
    }
...
int CommandLineParameters::accessAttribute(t_ACCESSOR& accessor, int id) const
{
    ...
    case ATTRIBUTE_ID_TIMESTAMP_GT: {
        return accessor(d_timestampGt,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_TIMESTAMP_GT]);
    }
    case ATTRIBUTE_ID_TIMESTAMP_LT: {
        return accessor(d_timestampLt,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_TIMESTAMP_LT]);
    }
    case ATTRIBUTE_ID_DETAILS: {
        return accessor(d_details,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_DETAILS]);
    }
    case ATTRIBUTE_ID_DUMP_PAYLOAD: {
        return accessor(d_dumpPayload,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_DUMP_PAYLOAD]);
    }
    case ATTRIBUTE_ID_DUMP_LIMIT: {
        return accessor(d_dumpLimit,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_DUMP_LIMIT]);
    }
    case ATTRIBUTE_ID_SUMMARY: {
...
inline const bsl::string& CommandLineParameters::path() const
{
    return d_path;
}

inline const bsl::string& CommandLineParameters::journalFile() const
{
    return d_journalFile;
}

inline const bsl::string& CommandLineParameters::dataFile() const
{
    return d_dataFile;
}

inline const bsl::string& CommandLineParameters::qlistFile() const
{
    return d_qlistFile;
}

inline const bsl::vector<bsl::string>& CommandLineParameters::guid() const
{
    return d_guid;
}

inline const bsl::vector<bsl::string>& CommandLineParameters::queue() const
{
    return d_queue;
}

inline bsls::Types::Int64 CommandLineParameters::timestampGt() const
{
    return d_timestampGt;
}

inline bsls::Types::Int64 CommandLineParameters::timestampLt() const
{
    return d_timestampLt;
}

inline bool CommandLineParameters::details() const
{
    return d_details;
}

inline bool CommandLineParameters::dumpPayload() const
{
    return d_dumpPayload;
}

inline int CommandLineParameters::dumpLimit() const
{
    return d_dumpLimit;
}

inline bool CommandLineParameters::summary() const
{
    return d_summary;
}
    ...
    const m_bmqstoragetool::CommandLineParameters& rhs)
{
    return lhs.path() == rhs.path() &&
           ...
           lhs.qlistFile() == rhs.qlistFile() && lhs.guid() == rhs.guid() &&
           lhs.queue() == rhs.queue() &&
...
template <typename t_HASH_ALGORITHM>
void m_bmqstoragetool::hashAppend(
    t_HASH_ALGORITHM&                              hashAlg,
    const m_bmqstoragetool::CommandLineParameters& object)
{
