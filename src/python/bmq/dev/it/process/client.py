...
from bmq.dev.it.testconstants import *
...
class Client(bmq.dev.it.process.bmqproc.BMQProcess):
    ...
    def __init__(self, name, options=None, dump_messages=True, **kwargs):
        if options is None:
            options = []
        ...
        super().__init__(
            ...
            " ".join(
                [
                    "./run-client",
                    f'--logFormat="{bmq.dev.it.process.bmqproc.PROC_LOG_FORMAT}"',
                ]
                + options
            ),
