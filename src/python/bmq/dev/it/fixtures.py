...
import bmq.dev.it.process.bmqproc
import bmq.dev.it.testconstants as tc
import bmq.dev.workspace as ws
import bmq.util.logging as bul
import pytest
from bmq.schemas import mqbcfg, mqbconf
from bmq.dev.it.cluster import Cluster
from bmq.dev.it.tweaks import TWEAK_ATTRIBUTE, Tweak
from bmq.dev.it.tweaks import (
    tweak,  # pylint: disable=unused-import; not used here, imported for tests
)
from bmq.dev.it.util import internal_use
...
def cluster_fixture(request, configure) -> Generator:
    ...
    with contextlib.ExitStack() as on_exit:
        ...
        with contextlib.ExitStack() as scope:
            ...
            log_config.console_format = bmq.dev.it.process.bmqproc.PROC_LOG_FORMAT
            ...
            location = ws.HostLocation(workspace, work_dir)
            workspace.deploy(location)
