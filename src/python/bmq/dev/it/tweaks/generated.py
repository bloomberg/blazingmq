...
import bmq.schemas.mqbcfg
import bmq.schemas.mqbconf
    ...
    class Broker:
        class TaskConfig(metaclass=TweakMetaclass):
            class AllocatorType(metaclass=TweakMetaclass):
                ...
                def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.AllocatorType,NoneType]) -> Callable:
                    ...
            ...
            class LogController(metaclass=TweakMetaclass):
                ...
                class Syslog(metaclass=TweakMetaclass):
                    ...
                    def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.SyslogConfig,NoneType]) -> Callable:
                        ...
                syslog = Syslog()
                
            
                def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.LogController,NoneType]) -> Callable:
                    ...
            log_controller = LogController()
            
        
            def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.TaskConfig,NoneType]) -> Callable:
                ...
        ...
        class AppConfig(metaclass=TweakMetaclass):
            ...
            class DispatcherConfig(metaclass=TweakMetaclass):
                class Sessions(metaclass=TweakMetaclass):
                    ...
                    class ProcessorConfig(metaclass=TweakMetaclass):
                        ...
                        def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.DispatcherProcessorParameters,NoneType]) -> Callable:
                            ...
                    processor_config = ProcessorConfig()
                    
                
                    def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.DispatcherProcessorConfig,NoneType]) -> Callable:
                        ...
                sessions = Sessions()
                ...
                def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.DispatcherConfig,NoneType]) -> Callable:
                    ...
            ...
            class Stats(metaclass=TweakMetaclass):
                ...
                class Plugins(metaclass=TweakMetaclass):
                    ...
                    class PrometheusSpecific(metaclass=TweakMetaclass):
                        class Mode(metaclass=TweakMetaclass):
                            ...
                            def __call__(self, value: bmq.schemas.mqbcfg.ExportMode) -> Callable:
                                ...
                        mode = Mode()
                        ...
                        def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.StatPluginConfigPrometheus,NoneType]) -> Callable:
                            ...
                ...
                class Printer(metaclass=TweakMetaclass):
                    ...
                    def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.StatsPrinterConfig,NoneType]) -> Callable:
                        ...
                printer = Printer()
                
            
                def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.StatsConfig,NoneType]) -> Callable:
                    ...
            stats = Stats()
            ...
            class NetworkInterfaces(metaclass=TweakMetaclass):
                class Heartbeats(metaclass=TweakMetaclass):
                    ...
                    def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.Heartbeat,NoneType]) -> Callable:
                        ...
                ...
                class TcpInterface(metaclass=TweakMetaclass):
                    ...
                    def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.TcpInterfaceConfig,NoneType]) -> Callable:
                        ...
                tcp_interface = TcpInterface()
                
            
                def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.NetworkInterfaces,NoneType]) -> Callable:
                    ...
            ...
            class BmqconfConfig(metaclass=TweakMetaclass):
                ...
                def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.BmqconfConfig,NoneType]) -> Callable:
                    ...
            ...
            class Plugins(metaclass=TweakMetaclass):
                ...
                def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.Plugins,NoneType]) -> Callable:
                    ...
            plugins = Plugins()
            ...
            class MessagePropertiesV2(metaclass=TweakMetaclass):
                ...
                def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.MessagePropertiesV2,NoneType]) -> Callable:
                    ...
            ...
            def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.AppConfig,NoneType]) -> Callable:
                ...
    ...
    class Domain:
        ...
        class Mode(metaclass=TweakMetaclass):
            class Fanout(metaclass=TweakMetaclass):
                ...
                def __call__(self, value: typing.Union[bmq.schemas.mqbconf.QueueModeFanout,NoneType]) -> Callable:
                    ...
            fanout = Fanout()
            
            class Priority(metaclass=TweakMetaclass):
            
                def __call__(self, value: typing.Union[bmq.schemas.mqbconf.QueueModePriority,NoneType]) -> Callable:
                    ...
            priority = Priority()
            
            class Broadcast(metaclass=TweakMetaclass):
            
                def __call__(self, value: typing.Union[bmq.schemas.mqbconf.QueueModeBroadcast,NoneType]) -> Callable:
                    ...
            broadcast = Broadcast()
            
        
            def __call__(self, value: typing.Union[bmq.schemas.mqbconf.QueueMode,NoneType]) -> Callable:
                ...
        mode = Mode()
        ...
        class Storage(metaclass=TweakMetaclass):
            class DomainLimits(metaclass=TweakMetaclass):
                ...
                def __call__(self, value: typing.Union[bmq.schemas.mqbconf.Limits,NoneType]) -> Callable:
                    ...
            ...
            class Config(metaclass=TweakMetaclass):
                class InMemory(metaclass=TweakMetaclass):
                    ...
                    def __call__(self, value: typing.Union[bmq.schemas.mqbconf.InMemoryStorage,NoneType]) -> Callable:
                        ...
                in_memory = InMemory()
                
                class FileBacked(metaclass=TweakMetaclass):
                
                    def __call__(self, value: typing.Union[bmq.schemas.mqbconf.FileBackedStorage,NoneType]) -> Callable:
                        ...
                file_backed = FileBacked()
                
            
                def __call__(self, value: typing.Union[bmq.schemas.mqbconf.Storage,NoneType]) -> Callable:
                    ...
            config = Config()
            
        
            def __call__(self, value: typing.Union[bmq.schemas.mqbconf.StorageDefinition,NoneType]) -> Callable:
                ...
        storage = Storage()
        ...
        class MsgGroupIdConfig(metaclass=TweakMetaclass):
            ...
            def __call__(self, value: typing.Union[bmq.schemas.mqbconf.MsgGroupIdConfig,NoneType]) -> Callable:
                ...
        ...
        class Consistency(metaclass=TweakMetaclass):
            class Eventual(metaclass=TweakMetaclass):
                ...
                def __call__(self, value: typing.Union[bmq.schemas.mqbconf.QueueConsistencyEventual,NoneType]) -> Callable:
                    ...
            eventual = Eventual()
            
            class Strong(metaclass=TweakMetaclass):
            
                def __call__(self, value: typing.Union[bmq.schemas.mqbconf.QueueConsistencyStrong,NoneType]) -> Callable:
                    ...
            strong = Strong()
            
        
            def __call__(self, value: typing.Union[bmq.schemas.mqbconf.Consistency,NoneType]) -> Callable:
                ...
    ...
    class Cluster:
        ...
        class Nodes(metaclass=TweakMetaclass):
            ...
            class Transport(metaclass=TweakMetaclass):
                class Tcp(metaclass=TweakMetaclass):
                    ...
                    def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.TcpClusterNodeConnection,NoneType]) -> Callable:
                        ...
                tcp = Tcp()
                
            
                def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.ClusterNodeConnection,NoneType]) -> Callable:
                    ...
            transport = Transport()
        ...
        class PartitionConfig(metaclass=TweakMetaclass):
            ...
            class SyncConfig(metaclass=TweakMetaclass):
                ...
                def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.StorageSyncConfig,NoneType]) -> Callable:
                    ...
            sync_config = SyncConfig()
            
        
            def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.PartitionConfig,NoneType]) -> Callable:
                ...
        partition_config = PartitionConfig()
        
        class MasterAssignment(metaclass=TweakMetaclass):
        
            def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.MasterAssignmentAlgorithm,NoneType]) -> Callable:
                ...
        ...
        class Elector(metaclass=TweakMetaclass):
            ...
            def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.ElectorConfig,NoneType]) -> Callable:
                ...
        elector = Elector()
        ...
        class QueueOperations(metaclass=TweakMetaclass):
            ...
            def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.QueueOperationsConfig,NoneType]) -> Callable:
                ...
        ...
        class ClusterAttributes(metaclass=TweakMetaclass):
            ...
            def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.ClusterAttributes,NoneType]) -> Callable:
                ...
        ...
        class ClusterMonitorConfig(metaclass=TweakMetaclass):
            ...
            def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.ClusterMonitorConfig,NoneType]) -> Callable:
                ...
        ...
        class MessageThrottleConfig(metaclass=TweakMetaclass):
            ...
            def __call__(self, value: typing.Union[bmq.schemas.mqbcfg.MessageThrottleConfig,NoneType]) -> Callable:
                ...
