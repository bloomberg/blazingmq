...
// specified major and minor version composed using the 'BDE_MAKE_VERSION' macro:
//..
...
#define PLUGINS_VERSION PLUGINS_MAKE_VERSION(PLUGINS_VERSION_MAJOR, \
...
#define PLUGINS_EXT_VERSION PLUGINS_MAKE_EXT_VERSION(                     \
