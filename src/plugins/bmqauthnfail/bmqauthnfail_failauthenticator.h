...
// bmqauthnfail_passauthenticator.h                             -*-C++-*-
#ifndef INCLUDED_AUTHNFAIL_PASSAUTHENTICATOR
#define INCLUDED_AUTHNFAIL_PASSAUTHENTICATOR

//@PURPOSE: Provide a plugin that always authenticates successfully.
//
//@CLASSES:
//  bmqauthnfail::PassAuthenticator: Authenticator plugin that unconditionally
//  accepts any authentication request.
//
//@DESCRIPTION:
//  'bmqauthnfail::PassAuthenticator' implements a dummy authenticator for
...
class PassAuthenticator : public mqbplug::Authenticator {
    ...
    BALL_LOG_SET_CLASS_CATEGORY("BMQAUTHNFAIL.PASSAUTHENTICATOR");
