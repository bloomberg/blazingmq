...
//@PURPOSE: Provide library of Pass Authenticator plugin for broker.
//
//@CLASSES:
//  bmqauthnfail::PluginLibrary: Library of Pass Authenticator plugin.
//
//@DESCRIPTION: This component provides the definition for the 'PluginLibrary'
// class, which represents and publishes Pass Authenticator plugin for
