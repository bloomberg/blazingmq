...
// bmqauthnfail_pluginlibrary.h                             -*-C++-*-
#ifndef INCLUDED_AUTHNFAIL_PLUGINLIBRARY
#define INCLUDED_AUTHNFAIL_PLUGINLIBRARY

//@PURPOSE: Provide library of Fail Authenticator plugin for broker.
//
//@CLASSES:
//  bmqauthnfail::PluginLibrary: Library of Fail Authenticator plugin.
//
//@DESCRIPTION: This component provides the definition for the 'PluginLibrary'
// class, which represents and publishes Fail Authenticator plugin for
