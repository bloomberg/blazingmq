...
: d_plugins(bslma::Default::allocator(allocator))
{
    ...
    authnfailPluginInfo.setFactory(
        bsl::allocate_shared<FailAuthenticatorPluginFactory>(allocator));
    authnfailPluginInfo.setVersion(Version::version());
    authnfailPluginInfo.setDescription("Fail Authenticator");
}
