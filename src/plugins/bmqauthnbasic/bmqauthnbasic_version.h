...
#ifndef INCLUDED_AUTHNBASIC_VERSION
#define INCLUDED_AUTHNBASIC_VERSION

//@PURPOSE: Provide source control management (versioning) information.
//
//@CLASSES:
//  bmqauthnbasic::Version: namespace for 'bmqauthnbasic' SCM versioning
//  information
//
//@DESCRIPTION: This component provides source control management (versioning)
// information for the 'bmqauthnbasic' plugin.  In particular, this component
// embeds RCS-style and SCCS-style version strings in binary executable files
// that use one or more components from the 'bmqauthnbasic' plugin.  This
...
// member function in the 'bmqauthnbasic::Version' struct can be used to query
// version information for the 'bmqauthnbasic' plugin at runtime.  The
...
// "#include" this component header file to get 'bmqauthnbasic' version
// information embedded in an executable.  It is only necessary to use one or
// more 'bmqauthnbasic' components (and, hence, link in the 'bmqauthnbasic'
// library).

// AUTHNBASIC
#include <bmqauthnbasic_versiontag.h>
...
#define AUTHNBASIC_CONCAT2(a, b, c, d, e) a##b##c##d##e
#define AUTHNBASIC_CONCAT(a, b, c, d, e) AUTHNBASIC_CONCAT2(a, b, c, d, e)

// 'AUTHNBASIC_S_VERSION' is a symbol whose name warns users of version
...
#define AUTHNBASIC_S_VERSION                                                  \
    AUTHNBASIC_CONCAT(d_version_AUTHNBASIC_,                                  \
                      AUTHNBASIC_VERSION_MAJOR,                               \
                      _,                                                      \
                      AUTHNBASIC_VERSION_MINOR,                               \
                      _compiled_this_object)

    static const char* AUTHNBASIC_S_VERSION;
    ...
    // BLP_LIB_AUTHNBASIC_<major>.<minor>.<patch>
...
// ---------------------------
// class bmqauthnbasic::Version
// ---------------------------

inline const char* Version::version()
{
    return AUTHNBASIC_S_VERSION;
}

inline int Version::versionAsInt()
{
    return AUTHNBASIC_EXT_VERSION;
}
