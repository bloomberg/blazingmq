...
// bmqauthnbasic_pluginlibrary.h                             -*-C++-*-
#ifndef INCLUDED_AUTHNBASIC_PLUGINLIBRARY
#define INCLUDED_AUTHNBASIC_PLUGINLIBRARY

//@PURPOSE: Provide library of Basic Authenticator plugin for broker.
//
//@CLASSES:
//  bmqauthnbasic::PluginLibrary: Library of Basic Authenticator plugin.
//
//@DESCRIPTION: This component provides the definition for the 'PluginLibrary'
// class, which represents and publishes Basic Authenticator plugin for
// interfacing with the BMQ broker (i.e., 'bmqbrkr.tsk').
