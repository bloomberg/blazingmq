...
| <a name="fig4" href="{{ site.baseurl }}/assets/images/2024-11-13-performance-update/tmp_function.png">![blob copy perf]({{ site.baseurl }}/assets/images/2024-11-13-performance-update/tmp_function.png)</a> |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
